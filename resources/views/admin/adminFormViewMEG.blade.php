...
<div class="container">
  <div class="col-md-12">
    ...
    @if(session('adminCourse') == "MCA" || session('course')=="MCA")
      {{-- Dte Details --}}
      <form method="post" action="{{ route('update_mca_dte_details') }}" novalidate>
        {{csrf_field()}}
      ...
      {{-- Academic Details --}}
      <form method="post" action="{{ route('update_mca_academic_details') }}" novalidate>
        {{csrf_field()}}
        <table class="table table-bordered table-striped" id="academicDetails" style="display: none">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <input type="text" class="form-control" id="xPassingMonth" name="xPassingMonth" value="{{$user1[0]->x_passing_month}}" placeholder="Enter Month">
              </td>
              <th>Year of Passing</th>
              <td>
                <input type="text" class="form-control" id="xPassingYear" name="xPassingYear"  value="{{$user1[0]->x_passing_year}}">
              </td>
            </tr>
            <script type="text/javascript">
              function xpercent() {
            ...
            <tr>
              <th>Month of Passing</th>
              <td>
                <input type="text" class="form-control" id="xiipassingMonth" name="xiipassingMonth" value="{{$user1[0]->xii_passing_month}}" placeholder="Enter Month">
              </td>
              <th>Year of Passing</th>
              <td>
                <input type="text" class="form-control" id="xiipassingYear" name="xiipassingYear" value="{{$user1[0]->xii_passing_year}}" placeholder="Enter Year">
              </td>
            </tr>
            <script type="text/javascript">
              function xiipercent() {
            ...
            <tr>
              <th>Month of Passing</th>
              <td>
                <input type="text" class="form-control" id="diplomaPassingMonth" name="diplomaPassingMonth" value="{{$user1[0]->diploma_passing_month}}" placeholder="Enter Month">
              </td>
              <th>Year of Passing</th>
              <td>
                <input type="text" class="form-control" id="diplomaPassingYear" name="diplomaPassingYear" value="{{$user1[0]->diploma_passing_year}}" placeholder="Enter Year">
              </td>
            </tr>
            <script type="text/javascript">
              function dippercent() {
            ...
            <tr>
              <th>Month of Passing</th>
              <td>
                <input type="text" class="form-control" id="degreePassingMonth" name="degreePassingMonth" value="{{$user1[0]->degree_passing_month}}" placeholder="Enter Month">
              </td>
              <th>Year of Passing</th>
              <td>
                <input type="text" class="form-control" id="degreePassingYear" name="degreePassingYear" value="{{$user1[0]->degree_passing_year}}" placeholder="Enter Year">
              </td>
            </tr>
            <tr>
      ...
      {{-- Personal Details --}}
      <form method="post" action="{{ route('update_mca_personal_details') }}" novalidate>
        {{csrf_field()}}
      ...
      {{-- Guardian Details --}}
      <form method="post" action="{{ route('update_mca_guardian_details') }}" novalidate>
        {{csrf_field()}}
      ...
      {{-- Contact Details --}}
      <form method="post" action="{{ route('update_mca_contact_details') }}" novalidate>
        {{csrf_field()}}
    ...
    @elseif(session('adminCourse')== "MEG" || session('course')=="MEG")
      {{-- Dte Details --}}
      <form method="post" action="{{ route('update_me_dte_details') }}" novalidate>
        {{csrf_field()}}
        <table class="table table-bordered table-striped" id="dteDetails" style="display: none">
          <tr>
            ...
            <th>Gate Score / Marks</th>
            <td>
              <input type="text" class="form-control" id="gateScore" name="gateScore" value="{{$user1[0]->gate_score}}"placeholder="Enter Gate Score">
            </td>
          </tr>
          <tr>
            <th>Gate Branch</th>
          ...
          <tr>
            ...
            <th>Year of Exam</th>
            <td>
              <select id="yearOfExam" name="yearOfExam" class="form-control" required> </select>
              <script type="text/javascript">
                var dt = new Date();
                var year = 1990;
          ...
          <tr>
            <th>MH State DTE General Merit No.</th>
            <td>
              <input type="text" class="form-control" id="mhStateGeneralMeritNo" name="mhStateGeneralMeritNo" value="{{$user1[0]->mh_state_general_merit_no}}" placeholder="Enter MH State general merit no.">
            </td>
            <th>Minority DTE Merit No.</th>
            <td>
              <input type="text" class="form-control" id="minorityDteMeritNo" name="minorityDteMeritNo" value="{{$user1[0]->minority_dte_merit_no}}" placeholder="Enter Minority dte merit no.">
            </td>
          </tr>
          <tr>
            <th>Seat Type</th>
            ...
            <th>Choice Code</th>
            <td>
              <input type="text" class="form-control" id="choiceCode" name="choiceCode" value="{{$user1[0]->choice_code_allotted}}"  placeholder="Dte Choice Code" disabled>
            </td>
          </tr>
          <tr>
            <th>Cap Round</th>
          ...
          <tr style="text-align: center; background-color: #002147;">
              <td colspan="4">
                  ...
                  <button type="submit" class="btn btn" id="updatePersonalDetails" style="background-color: #002147; color: #ffffff">Update DTE Details</button>
      ...
      {{-- Academic Details --}}
      <form method="post" action="{{ route('update_me_academic_details') }}" novalidate>
        {{csrf_field()}}
        <table class="table table-bordered table-striped" id="academicDetails" style="display: none">
          <tbody>
            <tr>
            ...
            <tr>
              <th>Degree Name</th>
              <td >
                <input type="text" class="form-control" id="degreeName" name="degreeName" value="{{$user1[0]->degree_name}}" placeholder=" Name">
              </td>
            
              <th>College Name</th>
              <td >
                <input type="text" class="form-control" id="degreeCollegeName" name="degreeCollegeName" value="{{$user1[0]->degree_college_name}}" placeholder="College Name">
              </td>
            </tr>
            ...
            <tr>
              <th>Sem 7 obtained</th>
              <td>
                <input type="text" class="form-control" id="degree_7_marks_obt" name="degree_7_marks_obt" value="{{$user1[0]->degree_sem_7_obt_marks}}" placeholder="Obtained Marks" onblur="olddegpercent()">
              </td>
              <th>Sem 7 Max</th>
              <td>
                <input type="text" class="form-control" id="degree_7_marks_max" name="degree_7_marks_max" value="{{$user1[0]->degree_sem_7_max_marks}}" placeholder="Max Marks" onblur="olddegpercent()">
              </td>
            </tr>
            <tr>
              <th>Sem 8 obtained</th>
              <td>
                <input type="text" class="form-control" id="degree_8_marks_obt" name="degree_8_marks_obt" value="{{$user1[0]->degree_sem_8_obt_marks}}" placeholder="Obtained Marks" onblur="olddegpercent()">
              </td>
              <th>Sem 8 Max</th>
              <td>
                <input type="text" class="form-control" id="degree_8_marks_max" name="degree_8_marks_max" value="{{$user1[0]->degree_sem_8_max_marks}}" placeholder="Max Marks" onblur="olddegpercent()">
              </td>
            </tr>
            <script type="text/javascript">
              function olddegpercent() {
                var aggrObt = parseInt(document.getElementById('degree_1_marks_obt').value) +
                              ...
                              parseInt(document.getElementById('degree_5_marks_obt').value) +
                              parseInt(document.getElementById('degree_6_marks_obt').value) +
                              parseInt(document.getElementById('degree_7_marks_obt').value) +
                              parseInt(document.getElementById('degree_8_marks_obt').value);
                ...
                var aggrMax = parseInt(document.getElementById('degree_1_marks_max').value) +
                              ...
                              parseInt(document.getElementById('degree_5_marks_max').value) +
                              parseInt(document.getElementById('degree_6_marks_max').value) +
                              parseInt(document.getElementById('degree_7_marks_max').value) +
                              parseInt(document.getElementById('degree_8_marks_max').value);
      ...
      {{-- Personal Details --}}
      <form method="post" action="{{ route('update_me_personal_details') }}" novalidate>
        {{csrf_field()}}
        <table class="table table-bordered table-striped" id="personalDetails" style="display: none">
          <tbody>
             <tr> 
      ...
      {{-- Guardian Details --}}
      <form method="post" action="{{ route('update_me_guardian_details') }}" novalidate>
        {{csrf_field()}}
        <table class="table table-bordered table-striped" id="guardianDetails" style="display: none">
          <tbody>
            <tr>
      ...
      {{-- Contact Details --}}
      <form method="post" action="{{ route('update_me_contact_details') }}" novalidate>
        {{csrf_field()}}
        <table class="table table-bordered table-striped" id="contactDetails" style="display: none">
          <tbody>
            <tr>
            ...
            <tr>
              <th>State{{$user1[0]->permanent_state}}</th>
              <td>
                <input type="text" class="form-control" id="permanentAddressState" name="permanentAddressState" value="{{$user1[0]->permanent_state}}" placeholder="Enter State">
              </td>
              <th>Pincode</th>
...
<form method="post" action="{{ url('mailpage') }}">
          <table style="width: 1100px; margin-left: 5px;" class="table table-bordered table-striped">
              <tr>
