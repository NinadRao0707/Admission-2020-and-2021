...
<div class="container">
  <div id="myCarousel" class="carousel slide" data-interval="false">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item">
        <object data="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->gate_result_path) }}" type="application/pdf" width="1150" height="800">
        <embed src="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->gate_result_path) }}" />
        </embed>
        </object>
      </div>
      @endif
      ...
      @if(session('adminCourse')=="MEG")
         @if($user1[0]->third_year_marksheet == 'Yes')
      <div class="item">
        <object data="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->fourth_year_marksheet_path) }}" type="application/pdf" width="1150" height="800">
        <embed src="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->fourth_year_marksheet_path) }}" />
        </embed>
        </object>
      </div>
        @endif
