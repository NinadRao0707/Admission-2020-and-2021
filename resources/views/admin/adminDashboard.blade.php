          ...
          <div class="form-group col-md-12">
            ...
            <div class="card text-white bg-secondary o-hidden h-100 col-md-2">
              <div class="card-body">
                ...
                <div class="mr-5">Morning I Shift</div>
              </div>
            </div>
            <div class="col-md-1"></div>
            <div class="card text-white bg-danger o-hidden h-100 col-md-3">
          ...
          <div class="form-group col-md-12">
            ...
            <div class="card text-white bg-secondary o-hidden h-100 col-md-2">
              <div class="card-body">
                ...
                <div class="mr-5">Morning II Shift</div>
              </div>
            </div>
            <div class="col-md-1"></div>
            <div class="card text-white bg-danger o-hidden h-100 col-md-3">
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-10">
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  <td colspan="2">Morning I Shift</td>
                  <td colspan="1">{{$amg}}</td>
                  <td colspan="2">Morning I Shift</td>
                  <td colspan="1">{{$ams}}</td>
                </tr>
                <tr>
                  <td colspan="2">Morning II Shift</td>
                  <td colspan="1">{{$afg}}</td>
                  <td colspan="2">Morning II Shift</td>
                  <td colspan="1">{{$afs}}</td>
                </tr>
          ...
          <div class="form-group col-md-12">
            ...
            <div class="card text-white bg-secondary o-hidden h-100 col-md-3">
              <div class="card-body">
                ...
                <div class="mr-5">CMP MORNG I</div>
              </div>
            </div>
            <div class="col-md-1"></div>
            <div class="card text-white bg-danger o-hidden h-100 col-md-3">
          ...
          <div class="form-group col-md-12">
            ...
            <div class="card text-white bg-secondary o-hidden h-100 col-md-3">
              <div class="card-body">
                ...
                <div class="mr-5">CMP MORNG II</div>
              </div>
            </div>
            <div class="col-md-1"></div>
            <div class="card text-white bg-danger o-hidden h-100 col-md-3">
          ...
          <div class="form-group col-md-12">
            ...
            <div class="card text-white bg-danger o-hidden h-100 col-md-3">
              <div class="card-body">
                ...
                <div class="mr-5">{{$data['remAIDS']}} Remaining</div>
              </div>
            </div>
            <div class="col-md-1"></div>
            <div class="card text-white bg-success o-hidden h-100 col-md-3">
              <div class="card-body">
                ...
                <div class="mr-5">{{$data['fillAIDS']}} Filled</div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-11">
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  <td colspan="2">Artificial Intelligence And Data Science</td>
                  <td colspan="1">{{$data['AAIDSo']}}</td>
                  <td colspan="2">Artificial Intelligence And Data Science</td>
                  <td colspan="1">{{$data['AAIDSs']}}</td>
                </tr>
                <tr>
          ...
          <div class="col-md-11">
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  <td colspan="2">Artificial Intelligence And Data Science</td>
                  <td colspan="1">{{$data['DAIDSo']}}</td>
                  <td colspan="2">Artificial Intelligence And Data Science</td>
                  <td colspan="1">{{$data['DAIDSs']}}</td>
                </tr>
                <tr>
                  <td colspan="2">Information Technology</td>
