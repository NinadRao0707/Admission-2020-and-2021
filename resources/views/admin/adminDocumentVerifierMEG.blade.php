...
<html lang="en" class="no-js">
      ...
      <div class="container">
        ...
        <div class="col-md-10">
          ...
          <form method="post" action="{{ route('adminSearchDocumentVerifier') }}" >
            ...
            <br><br><br><br>
            <form method="post" action="{{ route('adminDocumentVerifierMEG') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="col-md-10">
                ...
                <table class="table table-bordered table-striped" style="width: 900px;">
                  <thead>
                    <tr>
                      ...
                      <th><a href="{{ route('adminViewAllDocumentsMEG') }}" target="_blank"><button type="button" class="button" style="width: 100%;padding:8px;">View All</button></a></th>
                  ...
                  <tbody>
                    ...
                    <td>ii</td>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Signature "  onclick="inserttotext()" id="checkbox2"></td>

                    </tr>


                    <td>iii</td>
                      <td>eScutiny Centre Confirmation Receipt</td>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->fc_confirmation_receipt_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->fc_confirmation_receipt_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="eScutiny Centre Confirmation Receipt "  onclick="inserttotext()" id="checkbox3"></td>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->dte_allotment_letter_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->dte_allotment_letter_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                    ...
                    <td>v</td>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->arc_ackw_receipt_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->arc_ackw_receipt_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" style="display:none;" value="ARC Acknowledgement"  onclick="inserttotext()" id="checkbox5"></td>
                    ...
                    <td>1</td>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->gate_result_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->gate_result_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><a href="{{route('deleteAdmin','gate_result')}}"><button type="button" class="btn" id="pdf_gate_result_delete" style="width: 100%;">Delete</button></a></td>
                      @else
                      <td>Not Uploaded</td>
                      <td><button type="button" disabled class="btn" style="width: 100%;">View</button></td>
                      <td>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="GATE Result"  onclick="inserttotext()" id="checkbox6"></td>
                    ...
                    <td>1</td>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->cet_result_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->cet_result_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="CET Result"  onclick="inserttotext()" id="checkbox7"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->ssc_marksheet_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->ssc_marksheet_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="SSC Marksheet"  onclick="inserttotext()" id="checkbox8"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->hsc_diploma_marksheet_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->hsc_diploma_marksheet_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="HSC / Diploma Marksheet"  onclick="inserttotext()" id="checkbox9"></td>
                      ...
                      <td><a href="{{route('deleteAdmin','hsc_marksheet')}}"><button type="button" class="btn" id="pdf_hsc_delete" style="width: 100%;">Delete</button></a></td>
                      @else
                      <td>Not Uploaded</td>
                      <td><button type="button" disabled class="btn" style="width: 100%;">View</button></td>
                      <td>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="HSC / Diploma Marksheet"  onclick="inserttotext()" id="checkbox10"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->degree_leaving_tc_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->degree_leaving_tc_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><a href="{{route('deleteAdmin','degree_leaving_tc')}}"><button type="button" class="btn" id="pdf_hsc_leaving_certi_delete" style="width: 100%;">Delete</button></a></td>
                      @else
                      <td>Not Uploaded</td>
                      <td><button type="button" disabled class="btn" style="width: 100%;">View</button></td>
                      <td>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Degree Leaving/Transfer Certificate"  onclick="inserttotext()" id="checkbox11"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->first_year_marksheet_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->first_year_marksheet_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="First Year Marksheet"  onclick="inserttotext()" id="checkbox12"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->second_year_marksheet_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->second_year_marksheet_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Second Year Marksheet"  onclick="inserttotext()" id="checkbox13"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->third_year_marksheet_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->third_year_marksheet_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Third Year Marksheet"  onclick="inserttotext()" id="checkbox14"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->fourth_year_marksheet_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->fourth_year_marksheet_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Fourth  Year Marksheet"  onclick="inserttotext()" id="checkbox15"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->convocation_passing_certi_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->convocation_passing_certi_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Convocation Certificate"  onclick="inserttotext()" id="checkbox16"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->migration_certi_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->migration_certi_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Migration Certificate"  onclick="inserttotext()" id="checkbox17"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->birth_certi_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->birth_certi_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Birth Certificate"  onclick="inserttotext()" id="checkbox18"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->domicile_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->domicile_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Domicile Certificate"  onclick="inserttotext()" id="checkbox19"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->proforma_o_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->proforma_o_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Proforma O"  onclick="inserttotext()" id="checkbox20"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->retention_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->retention_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Retention Certificate "  onclick="inserttotext()" id="checkbox21"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->minority_affidavit_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->minority_affidavit_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Minority Affidavit"  onclick="inserttotext()" id="checkbox22"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->gap_certi_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->gap_certi_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Gap Certificate"  onclick="inserttotext()" id="checkbox23"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->community_certi_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->community_certi_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Community Certificate"  onclick="inserttotext()" id="checkbox24"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->caste_certi_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->caste_certi_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Caste Certificate"  onclick="inserttotext()" id="checkbox25"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->caste_validity_certi_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->caste_validity_certi_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Caste Validity Certificate"  onclick="inserttotext()" id="checkbox26"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->non_creamy_layer_certi_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->non_creamy_layer_certi_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Non-Creamy Layer Certificate"  onclick="inserttotext()" id="checkbox27"></td>
                   ...
                   {{--  <tr>
                      ...
                      <td><a href="{{route('deleteAdmin','proforma_h')}}"><button type="button" class="btn" id="pdf_proforma_h_delete" style="width: 100%;">Delete</button></a></td>
                      @else
                      <td>Not Uploaded</td>
                      <td><button type="button" disabled class="btn" style="width: 100%;">View</button></td>
                      <td>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Proforma H"  onclick="inserttotext()" id="checkbox28"></td>
 ...
 --}}
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->proforma_a_b1_b2_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->proforma_a_b1_b2_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Proforma A B1 B2  "  onclick="inserttotext()" id="checkbox29"></td>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->income_certi_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->income_certi_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Income Certificate  "  onclick="inserttotext()" id="checkbox30"></td>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->proforma_c_d_e_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->proforma_c_d_e_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->proforma_j_k_l_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->proforma_j_k_l_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->medical_certi_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->medical_certi_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->anti_ragging_affidavit_path) }}" type="application/pdf" width="100%" height="500px">
                            <embed src="{{ asset('/uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->anti_ragging_affidavit_path) }}"  width="1200px" height="500px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
