...
<html lang="en" class="no-js">
      ...
      <div class="container">
        ...
        <div class="col-md-10">
          <h1>Document Verifier</h1>
            <form method="post" action="{{ route('adminDocumentVerifierAcap') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="col-md-10">
                ...
                <table class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th><a href="{{ route('adminViewAllDocumentsAcap') }}" target="_blank"><button type="button" class="button" style="width: 100%;">View All</button></a></th>
                      <th> Not proper </th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Degree Leaving/Transfer Certificate" name="Degree_Leaving_Transfer_Certificate" onclick="inserttotext()" id="checkbox10"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                            <td><input type="checkbox" value="First Year Marksheet" name="First_Year_Marksheet" onclick="inserttotext()" id="checkbox11"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                       <td><input type="checkbox" value="Second Year Marksheet" name="Second_Year_Marksheet" onclick="inserttotext()" id="checkbox12"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                        <td><input type="checkbox" value="Non-Creamy Layer Certificate" name="Non-Creamy_Layer_Certificate" onclick="inserttotext()" id="checkbox27"></td>
                    </tr>
 ...
 --}}
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                         <td><input type="checkbox" value="Physical Fitness Certificate" name="Physical_Fitness_Certificate" onclick="inserttotext()" id="checkbox32"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                         <td><input type="checkbox" value="Anti Ragging Certificate" name="Anti_Ragging_Certificate" onclick="inserttotext()" id="checkbox33"></td>
                    </tr>
