...
<html lang="en" class="no-js">
      ...
      <div class="container">
        ...
        <div class="col-md-10">
          ...
          <form method="post" action="{{ route('adminSearchDocumentVerifier') }}" >
            ...
            <br><br><br><br>
            <form method="post" action="{{ route('adminDocumentVerifier') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="col-md-10">
                ...
                <table style="width: 900px;" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th><a href="{{ route('adminViewAllDocuments') }}" target="_blank"><button type="button" class="button" style="width: 100%;padding:8px;">View All</button></a></th>
                      <th> Not proper </th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <td>iii</td>
                      <td>eScrutiny Centre Confirmation Receipt</td>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                              <h4 class="modal-title">eScrutiny Centre Confirmation Receipt</h4>
                            </div>
                            <div class="modal-body">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="eScrutiny Centre Confirmation Receipt"  onclick="inserttotext()" id="checkbox3"></td>
                    ...
                    <td>v</td>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" style="display:none;" value=" "  onclick="inserttotext()" id="checkbox5"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="SSC Marksheet "  onclick="inserttotext()" id="checkbox7"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="HSC / Diploma Marksheet  "  onclick="inserttotext()" id="checkbox8"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Degree Leaving/Transfer Certificate   "  onclick="inserttotext()" id="checkbox9"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="First Year Marksheet    "  onclick="inserttotext()" id="checkbox10"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Second Year Marksheet    "  onclick="inserttotext()" id="checkbox11"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Convocation Certificate  "  onclick="inserttotext()" id="checkbox14"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Migration Certificate   "  onclick="inserttotext()" id="checkbox15"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Birth Certificate  "  onclick="inserttotext()" id="checkbox16"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Domicile Certificate   "  onclick="inserttotext()" id="checkbox17"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Proforma O    "  onclick="inserttotext()" id="checkbox18"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Retention Certificate "  onclick="inserttotext()" id="checkbox19"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Minority Affidavit   "  onclick="inserttotext()" id="checkbox20"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Gap Certificate   "  onclick="inserttotext()" id="checkbox21"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Community Certificate   "  onclick="inserttotext()" id="checkbox23"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Caste Validity Certificate   "  onclick="inserttotext()" id="checkbox24"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Non-Creamy Layer Certificate   "  onclick="inserttotext()" id="checkbox25"></td>
                   ...
                   {{--  <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Proforma H  "  onclick="inserttotext()" id="checkbox26"></td>
 ...
 --}}
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Proforma A B1 B2  "  onclick="inserttotext()" id="checkbox27"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Income Certificate  "  onclick="inserttotext()" id="checkbox28"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Proforma C D E  "  onclick="inserttotext()" id="checkbox29"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Physical Fitness Certificate   "  onclick="inserttotext()" id="checkbox30"></td>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Anti Ragging Certificate   "  onclick="inserttotext()" id="checkbox31"></td>
          ...
          <table style="width: 900px; margin-left:  15px;" class="table table-bordered table-striped">
              <tr>
                ...
                <td style="background-color: #002147; " >
                  ...
                  <!-- <script type="text/javascript">CKEDITOR.editorConfig = function (config) {
    config.language = 'en';
...
<textarea name="editor1" id="editor1" rows="10" style="display: none;" cols="80"></textarea>
                </td>
                <td style="background-color: #002147;"  >
