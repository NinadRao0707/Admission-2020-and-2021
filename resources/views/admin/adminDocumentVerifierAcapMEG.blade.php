                ...
                <table class="table table-bordered table-striped">
                  ...
                  <td><input type="checkbox" value="Profile Photo" name="Profile_Photo" onclick="inserttotext()" id="checkbox1"></td>
                    ...
                    <td>iii</td>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="eScutiny Centre Confirmation Receipt" name="FC_Confirmation_Receipt" onclick="inserttotext()" id="checkbox3"></td>
                    </tr>
                    ...
                    <td>iv</td>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->dte_allotment_letter_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->dte_allotment_letter_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="DTE Allotment Letter" name="DTE_Allotment_Letter" onclick="inserttotext()" id="checkbox4"></td>
                    </tr>
                    ...
                    <td>v</td>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->arc_ackw_receipt_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->arc_ackw_receipt_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                        <td><input type="checkbox" style="display:none;" value="ARC Acknowledgement" name="ARC_Acknowledgement" onclick="inserttotext()" id="checkbox5"></td>
                    </tr>
                    ...
                    <td>1</td>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->gate_result_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->gate_result_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="GATE Result" name="GATE_Result" onclick="inserttotext()" id="checkbox6"></td>
                    </tr>
                    ...
                    <td>1</td>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="CET Result" name="CET_Result" onclick="inserttotext()" id="checkbox7"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                       <td><input type="checkbox" value="SSC Marksheet" name="SSC_Marksheet" onclick="inserttotext()" id="checkbox8"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->hsc_diploma_marksheet_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->hsc_diploma_marksheet_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                         <td><input type="checkbox" value="HSC Diploma Marksheet" name="HSC_Diploma_Marksheet" onclick="inserttotext()" id="checkbox9"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->hsc_marksheet_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->hsc_marksheet_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="HSC Marksheet" name="HSC_Marksheet" onclick="inserttotext()" id="checkbox10"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->degree_leaving_tc_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->degree_leaving_tc_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                       <td><input type="checkbox" value="Degree Leaving/Transfer Certificate" name="Degree_Leaving_Transfer Certificate" onclick="inserttotext()" id="checkbox11"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->first_year_marksheet_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->first_year_marksheet_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="First Year Marksheet" name="First_Year_Marksheet" onclick="inserttotext()" id="checkbox12"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->second_year_marksheet_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->second_year_marksheet_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                       <td><input type="checkbox" value="Second Year Marksheet" name="Second_Year_Marksheet" onclick="inserttotext()" id="checkbox13"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->third_year_marksheet_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->third_year_marksheet_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                     <td><input type="checkbox" value="Third Year Marksheet" name="Third_Year_Marksheet" onclick="inserttotext()" id="checkbox14"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->fourth_year_marksheet_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->fourth_year_marksheet_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                     <td><input type="checkbox" value="Fourth Year Marksheet" name="Fourth_Year_Marksheet" onclick="inserttotext()" id="checkbox15"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->convocation_passing_certi_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->convocation_passing_certi_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Convocation Certificate" name="Convocation_Certificate" onclick="inserttotext()" id="checkbox16"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->migration_certi_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->migration_certi_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                     <td><input type="checkbox" value="Migration Certificate" name="Migration_Certificate" onclick="inserttotext()" id="checkbox17"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                          <td><input type="checkbox" value="Birth Certificate" name="Birth_Certificate" onclick="inserttotext()" id="checkbox18"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                    <td><input type="checkbox" value="Domicile Certificate" name="Domicile_Certificate" onclick="inserttotext()" id="checkbox19"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                          <td><input type="checkbox" value="Proforma O" name="Proforma_O" onclick="inserttotext()" id="checkbox20"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->retention_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->retention_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                         <td><input type="checkbox" value="Retention Certificate" name="Retention_Certificate" onclick="inserttotext()" id="checkbox21"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                        <td><input type="checkbox" value="Minority Affidavit" name="Minority_Affidavit" onclick="inserttotext()" id="checkbox22"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                       <td><input type="checkbox" value="Gap Certificate" name="Gap_Certificate" onclick="inserttotext()" id="checkbox23"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                             <td><input type="checkbox" value="Community Certificate" name="Community_Certificate" onclick="inserttotext()" id="checkbox24"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->caste_certi_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->caste_certi_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                         <td><input type="checkbox" value="Caste Certificate" name="Caste_Certificate" onclick="inserttotext()" id="checkbox25"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->caste_validity_certi_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->caste_validity_certi_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                         <td><input type="checkbox" value="Caste Validity Certificate" name="Caste_Validity_Certificate" onclick="inserttotext()" id="checkbox26"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->non_creamy_layer_certi_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->non_creamy_layer_certi_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                       <td><input type="checkbox" value="Non-Creamy Layer Certificate" name="Non_Creamy_Layer_Certificate" onclick="inserttotext()" id="checkbox27"></td>
                    </tr>
                   ...
                   {{--  <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Proforma H" name="Proforma_H" onclick="inserttotext()" id="checkbox28"></td>
                    </tr>
 --}}
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->proforma_a_b1_b2_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->proforma_a_b1_b2_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                       <td><input type="checkbox" value="Proforma A B1 B2" name="Proforma_A_B1_B2" onclick="inserttotext()" id="checkbox29"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->income_certi_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->income_certi_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                        <td><input type="checkbox" value="Income Certificate" name="Income_Certificate" onclick="inserttotext()" id="checkbox30"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->proforma_c_d_e_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->proforma_c_d_e_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                            <td><input type="checkbox" value="Proforma C D E" name="Proforma_C_D_E" onclick="inserttotext()" id="checkbox31"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->proforma_j_k_l_path) }}" type="application/pdf" width="100%" height="700px">
                            <embed src="{{ asset('uploads/'.$users[0]->dte_id.'_'.$hash.'/'.$users[0]->proforma_j_k_l_path) }}" width="1200px" height="800px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                        <td><input type="checkbox" value="Proforma J K L" name="Proforma_J_K_L" onclick="inserttotext()" id="checkbox32"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                        <td><input type="checkbox" value="Physical Fitness Certificate" name="Physical_Fitness_Certificate" onclick="inserttotext()" id="checkbox33"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><button type="button" disabled class="btn" style="width: 100%;">Delete</button></td>
                      @endif
                      <td><input type="checkbox" value="Anti Ragging Certificate" name="Anti_Ragging_Certificate" onclick="inserttotext()" id="checkbox34"></td>
                    </tr>
