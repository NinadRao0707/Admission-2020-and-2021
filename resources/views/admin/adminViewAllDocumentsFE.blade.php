...
<div class="container">
  <div id="myCarousel" class="carousel slide" data-interval="false">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item">
        <object data="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->jee_result_path) }}" type="application/pdf" width="1150" height="800">
        <embed src="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->jee_result_path) }}" />
        </embed>
        </object>
      </div>
      @endif
      ...
      <div class="item">
        <object data="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->hsc_marksheet_path) }}" type="application/pdf" width="1150" height="800">
        <embed src="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->hsc_marksheet_path) }}" />
        </embed>
        </object>
      </div>
      @endif
      ...
      <div class="item">
        <object data="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->hsc_leaving_certi_path) }}" type="application/pdf" width="1150" height="800">
        <embed src="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->hsc_leaving_certi_path) }}" />
        </embed>
        </object>
      </div>
      @endif
      ...
      <div class="item">
        <object data="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->hsc_passing_certi_path) }}" type="application/pdf" width="1150" height="800">
        <embed src="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->hsc_passing_certi_path) }}" />
        </embed>
        </object>
      </div>
      @endif
      ...
      <div class="item">
        <object data="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->aadhar_path) }}" type="application/pdf" width="1150" height="800">
        <embed src="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->aadhar_path) }}" />
        </embed>
        </object>
      </div>
      @endif
      ...
      <div class="item">
        <object data="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->proforma_f_f1_path) }}" type="application/pdf" width="1150" height="800">
        <embed src="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->proforma_f_f1_path) }}" />
        </embed>
        </object>
      </div>
      @endif
      ...
      <div class="item">
        <object data="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->proforma_j_k_l_path) }}" type="application/pdf" width="1150" height="800">
        <embed src="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->proforma_j_k_l_path) }}" />
        </embed>
        </object>
      </div>
      @endif
