...
<div class="col-md-12">
    <table>
        ...
        <tbody>
            ...
            <tr>
            <td style="font-size:15px;" id="d25" colspan="2"><center>DS&AI</center></td>
            <td style="font-size:15px;" id="d26"><center>{{$user[0]->aids_vac}}</td>
            <td style="font-size:15px;" id="d27"><center>{{$user[1]->aids_vac}}</td>
            <td style="font-size:15px;"><center><a href="{{route('updatevacantseats','aids_plus')}}"><button type="button" id="aids_plus" name="aids_plus">DS&AI<br>+</button></a></center></td>
            @if($user[0]->aids_vac != 0)
            <td style="font-size:15px;"><center><a href="{{route('updatevacantseats','aids_minus')}}"><button type="button" id="aids_minus" name="aids_minus">DS&AI<br>-</button></a></center></td>
            @endif
            <td style="font-size:15px;"><center><a href="{{route('updatevacantseats','aids_plus_sindhi')}}"><button type="button" id="aids_plus_sindhi" name="aids_plus_sindhi">DS&AI<br>+</button></a></center></td>
            @if($user[1]->aids_vac != 0)
            <td style="font-size:15px;"><center><a href="{{route('updatevacantseats','aids_minus_sindhi')}}"><button type="button" id="aids_minus_sindhi" name="aids_minus_sindhi">DS&AI<br>-</button></a></center></td>
            @endif
            </tr>
