...
<div class="col-md-12">
    <table>
        ...
        <tbody>
            ...
            <tr>
            <td style="font-size:45px;" id="d20" colspan="2"><center><b>AI&DS</b></center></td>
            <td style="font-size:45px;" id="d21"><center>{{$user[0]->aids_vac}}</td>
            <td style="font-size:45px;" id="d22"><center>{{$user[1]->aids_vac}}</td>
            </tr>
        </tbody>
    </table>
</div>
