            ...
            <div class="modal-body">
              ...
              <table role="table"  class="table table-striped table-bordered" id="academic_modal">
                ...
                <tbody>
                  ...
                  <tr role="row"  >
                    <td role="cell" >3</td>
                    <td role="cell" >SC Confirmation Reciept</td>
                  </tr>
                  <tr role="row"  >
                    <td role="cell" >4</td>
          ...
          <tbody>
            <div id="dteDocs">
              ...
              <tr role="row"  >
                ...
                <td role="cell"  data-label="DOCUMENT NAME" >Profile Photo<font> *</font><p style="color: red"> (only .jpg) </p></td>
                  ...
                  {{-- <a href="{{ asset('/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->photo_path) }}" id="view_photo" target="_blank">View Document</a> --}}
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <center>
                              <!-- <img src="{{ asset('/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->photo_path) }}" width="500">changes done to reflect on local system follow the same for other docs -->
              ...
              <tr role="row"  >
                ...
                <td role="cell" >Signature<font> *</font><p style="color: red"> (only .jpg) </p></td>
              ...
              <tr role="row"  >
                <td role="cell" >iii</td>
                <td role="cell" >SC Confirmation Receipt<font> *</font></td>
              ...
              <tr role="row"  >
                <td role="cell" >iv</td>
                <td role="cell" >DTE Allotment Letter<font> *</font><p style="color: red"> (only .pdf) </p></td>
            ...
            <tr role="row"  >
              <td role="cell" >1</td>
              <td role="cell" >SSC Marksheet<font> *</font><p style="color: red"> (only .pdf) </p></td>
            ...
            <tr role="row"  >
              <td role="cell" >3</td>
              <td role="cell" >Diploma/B.Sc. First Year Marksheet<font> *</font><p style="color: red"> (only .pdf) </p></td>
            ...
            <tr role="row"  >
              <td role="cell" >5</td>
              <td role="cell" >Diploma/B.Sc. Third Year Marksheet<font> *</font><p style="color: red"> (only .pdf) </p></td>
            ...
            <tr role="row"  >
              ...
              <td role="cell" >
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="fourth_year_marksheet" name="fourth_year_marksheet">
            ...
            <tr role="row" style="display:none"  >
              <td role="cell" >7</td>
              <td role="cell" >Passing Certificate<font> *</font><p style="color: red"> (only .pdf) </p></td>
            ...
            <tr role="row"  >
              <td role="cell" >9</td>
              <td role="cell" >Equivalent Certificate (other than MSBTE)<font> *</font><p style="color: red"> (only .pdf) </p></td>
              ...
              <td role="cell" >
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="equivalent_certi" name="equivalent_certi">
            ...
            <tr role="row"  >
              <td role="cell" >12</td>
              <td role="cell" >Proforma O<p style="color: red"> (only .pdf) </p></td>
            ...
            <tr role="row"  >
              <td role="cell" >14</td>
              <td role="cell" >Community <p style="color: red"> (only .pdf) </p></td>
            ...
            <tr role="row"  >
              <td role="cell" >15</td>
              <td role="cell" >Retention Certificate<p style="color: red"> (only .pdf) </p></td>
            ...
            <tr role="row"  >
              <td role="cell" >16</td>
              <td role="cell" >Nationality Certificate<p style="color: red"> (only .pdf) </p></td>
              ...
              <td role="cell" >
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="nationality_certi" name="nationality_certi">
            ...
            <tr role="row"  >
              <td role="cell" >17</td>
              <td role="cell" >Physical Fitness Certificate<font> *</font><p style="color: red"> (only .pdf) </p></td>
            ...
            <tr role="row"  >
              <td role="cell" >18</td>
              <td role="cell" >Anti Ragging Certificate<font> *</font><p style="color: red"> (only .pdf) </p></td>
            ...
            <tr role="row"  >
              <td role="cell" >19</td>
              <td role="cell" >Caste Certificate<p style="color: red"> (only .pdf) </p></td>
            ...
            <tr role="row"  >
              <td role="cell" >20</td>
              <td role="cell" >Caste Validity Certificate<p style="color: red"> (only .pdf) </p></td>
            ...
            <tr role="row"  >
              <td role="cell" >21</td>
              <td role="cell" >Non-Creamy Layer Certificate<p style="color: red"> (only .pdf) </p></td>
            ...
            <tr role="row"  >
              <td role="cell" >22</td>
              <td role="cell" >Income Certificate<p style="color: red"> (only .pdf) </p></td>
            ...
            <tr role="row"  >
              <td role="cell" >23</td>
              <td role="cell" >Gap Certificate<p style="color: red"> (only .pdf) </p></td>
