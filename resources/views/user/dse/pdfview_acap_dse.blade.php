...
<html>
   ...
   <body>
      ...
      <div class="container">
         <div class="col-md-12">
            <center>
                <img class="img-responsive" src="{{ asset('public/images/acap_header_dse_admissionForm.jpg') }}">
