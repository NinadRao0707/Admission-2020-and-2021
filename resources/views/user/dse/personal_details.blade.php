...
<div class="container">
     ...
     <!-- <div class="row-md-8">
        <aside>
          <div class="list-group">
            ...
            <a href="{{ route('dse_personal_details') }}" class="list-group-item active">
  ...
  <div class="col-md-12">
    ...
    <h1>Personal Details&nbsp&nbsp&nbsp<label class="btn btn-sm btn-danger" data-toggle="modal" data-target="#dtePersonal" id="myBtn"  onclick="myFunction()" style="font-weight: bold; border-radius: 100px">?</label></h1>
      <script>
function myFunction() {
  var a=document.getElementById("dtePersonal");
   a.classList.add("fade");
    ...
    @endif
    <!---------------------------------Modal Close------------------------------------------>
    <form method="post" action="{{ route('dse_personal_details') }}">
      {{ csrf_field() }}
      ...
      <div class="form-group col-md-6 col-sm-12">
        ...
        <input type="text" class="form-control" id="firstName" name="firstName" value = "{{$user1[0]->first_name}}" placeholder="Enter First Name" required>
      ...
      <div class="form-group col-md-6 col-sm-12">
        <label for="middleName">Middle Name<label style="color: red; font-size: 25px;vertical-align: sub;">&nbsp;</label></label>
        <input type="text" class="form-control" id="middleName" name="middleName" value = "{{$user1[0]->middle_name}}" placeholder="Enter Middle Name">
      ...
      <div class="form-group col-md-6 col-sm-12 ">
        ...
        <input type="text" class="form-control" id="lastName" name="lastName" value = "{{$user1[0]->last_name}}" placeholder="Enter Last Name" required>
      ...
      <div class="form-group  col-md-12 col-sm-12">
        ...
        @if( $genders != $user1[0]->gender OR $genders == "null")
        <input type="radio" id="{{$key}}" name="gender" value="{{$genders}}">{{$key}}&nbsp;&nbsp;
        @endif
        @if( $genders == $user1[0]->gender )
        <input type="radio"  id="{{$key}}" name="gender" value="{{$genders}}" checked>{{$key}}&nbsp;&nbsp;
        @endif
        @endforeach
      </div>
      ...
      <div class="form-group col-md-4 col-sm-12">
        ...
        <input type="text" class="form-control" id="casteTribe" name="casteTribe" value="{{$user1[0]->caste_tribe}}"   placeholder="casteTribe" maxlength="15" required>
      ...
      <div id="stdDomicileAppl" style="display: none;">
        <div class="form-group col-md-6 col-sm-12">
          <label for="applicationNumber">Student's Domicile Application No.</label>
        ...
        <div class="form-group col-md-6 col-sm-12">
          <label for="applictionDate">Date of Application of Student's Domicile</label>
      ...
      <div class="form-group col-md-6 col-sm-12">
        <a  href="{{ route('dse_academic_details') }}">
