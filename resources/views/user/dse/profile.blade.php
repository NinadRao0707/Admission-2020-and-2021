         ...
         <table class="table table-bordered table-striped">
           <thead>
            ...
            @foreach ($dtes as $dte)
              ...
              @endforeach
              <tr>
                    <td style=" " colspan="3" >   NOTE : THE PAYMENT LINK WILL BE ACTIVATED ON <strong>27<sup>th</sup> JAN </strong>(AFTER 11.59AM) TO <strong>28<sup>th</sup>JAN</strong> (TILL 4.30PM )  </td>
                    
                    <td style="text-transform: uppercase;background-color: #204a84" colspan="3" > <a href="dse_acap_form_payment"><button type="button" class="btn btn-success btn-view " style="width: 100%; text-transform: uppercase; border: 0px"  
                     <?php 
