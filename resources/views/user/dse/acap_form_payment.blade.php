      ...
      <form method="post" action="{{ route('dse_acap_form_payment') }}">
         ...
         <div class="form-group col-md-12">
           <div class="form-group col-md-12 col-sm-12 input-group">
              ...
              <input type="text" class="form-control" value ="1180" disabled style="color: black; min-width: 100px; margin-left: 10%; margin-right: 10%;">
...
<b><font color="blue">NOTE :DO NOT REVERT BACK FROM THE PAYMENT GATEWAY. RELOADING PAYMENT GATEWAY MULTIPLE TIMES CAN BLOCK THE USER. IN CASE OF SLOW INTERNET CONNECTION DO NOT REFRESH THE PAGE. BE PATIENT. </font> </b>
