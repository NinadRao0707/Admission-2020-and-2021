...
<html>
   ...
   <body>
      ...
      <div class="container">
         <div class="col-md-12">
            <center>
                <img class="img-responsive" src="{{ asset('public/images/header_dse_admissionForm.jpg') }}">
                  ...
                  <table>
                     <thead>
                        <tr>
                           ...
                           <th id="line" colspan="3"style="text-align: right;">Branch: {{$users1['branch_allotted']}}</th>
                        </tr>
                        <tr>
 ...
 <tr>
                  ...
                  <table>
                     <thead>
                        ...
                        <tr>
                           <td id="line" colspan="6">
                              <p>I Mr./Miss. <b>{{ $users1[0]->name_on_marksheet }}</b> hereby declare that I am taking admission to the Direct Second Year Bachelor of Engineering Course <b>{{ $users1['branch_allotted'] }}</b> branch for the Academic Year: <span><b>2020-21 </b></span> in V.E.S Institute of Technology, Chembur-74.</p>
                              <p>I am not submitting the following Original Documents at the time of the above said Admission:</p>
                           </td>
                        </tr>
                        @if( $users1[0]->photo == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive" src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Profile Photo</td>
                        </tr>
                        @endif
                        @if( $users1[0]->signature == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive" src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Signature</td>
                        </tr>
                        @endif
                        ...
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img  src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;HSC Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->first_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img  src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Diploma First Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->second_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img  src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Diploma Second Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->third_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img  src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Diploma Third Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->fourth_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img  src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Diploma fourth Year Marksheet</td>
                        </tr>
                        @endif
                        ...
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img  src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Equivalent Certificate</td>
                        </tr>
                        @endif
                        ...
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img  src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Diploma Leaving Certificate</td>
                        </tr>
                        @endif
                        ...
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img  src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Nationality Certificate</td>
                        </tr>
                        @endif
                  ...
                  <table>
                     <thead>
                        ...
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%">&nbsp;eScutiny Centre Confirmation</td>
                        </tr>
                        @endif
                        @if( $users1[0]->ssc_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%">&nbsp;SSC Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->hsc_diploma_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%">&nbsp;HSC / Diploma Marksheet</td>
                        </tr>
                        @endif
                         @if( $users1[0]->first_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%">&nbsp;First Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->second_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%">&nbsp;Second Year Marksheet</td>
                        </tr>
                        @endif

                        @if( $users1[0]->fourth_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%">&nbsp;Third Year Marksheet</td>
                        </tr>
                        @endif
                        <!--@if( $users1[0]->convocation_passing_certi == 'Yes')-->
                        <!--<tr>-->
                        <!--   <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%">&nbsp;Convocation/Passing Certificate</td>-->
                        <!--</tr>-->
                        <!--@endif-->

                         @if( $users1[0]->equivalent_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%">&nbsp;Retention Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->degree_leaving_tc == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%">&nbsp;Minority Affidavit</td>
                        </tr>
                        @endif
                        @if( $users1[0]->birth_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%">&nbsp;Birth Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->domicile == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%">&nbsp;Domicile Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_o == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%">&nbsp;Proforma O</td>
                        </tr>
                        @endif
                        ...
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%">&nbsp;Community Certificate</td>
                        </tr>
                        @endif
                  ...
                  <table>
                     <thead>
                        ...
                        <tr>
                           <td id="line" colspan="6">
                              <p>I Mr./Miss. <b>{{ $users1[0]->name_on_marksheet }}</b> hereby declare that I am taking admission to the Direct Second Year Bachelor of Engineering  <b>{{ $users1[0]->shift_allotted }} Shift</b> for the Academic Year: <b>2020-21 </b> in V.E.S Institute of Technology, Chembur-74.</p>
                              <p>I am not submitting the following Original Documents at the time of the above said Admission:</p>
                           </td>
                        </tr>
                        @if( $users1[0]->photo == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Profile Photo</td>
                        </tr>
                        @endif
                        @if( $users1[0]->signature == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Signature</td>
                        </tr>
                        @endif
                        @if( $users1[0]->fc_confirmation_receipt == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;eScutiny Centre Confirmation</td>
                        </tr>
                        @endif
                        @if( $users1[0]->ssc_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;SSC Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->hsc_diploma_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"  src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;HSC Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->first_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img  class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%"ss>&nbsp;&nbsp;&nbsp;Diploma First Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->second_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"  src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Diploma Second Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->third_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"  src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Diploma Third Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->fourth_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"  src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Diploma fourth Year Marksheet</td>
                        </tr>
                        @endif
                        <!--@if( $users1[0]->convocation_passing_certi == 'No')-->
                        <!--<tr>-->
                        <!--   <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"  src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Convocation/passing Certificate</td>-->
                        <!--</tr>-->
                        <!--@endif-->

                        @if( $users1[0]->equivalent_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"  src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Equivalent Certificate</td>
                        </tr>
                        @endif
                        ...
                        @if( $users1[0]->degree_leaving_tc == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Diploma Leaving Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->birth_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Birth Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->domicile == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Domicile Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_o == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Proforma O</td>
                        </tr>
                        @endif
                        @if( $users1[0]->retention == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Retention Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->minority_affidavit == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Minority Affidavit</td>
                        </tr>
                        @endif

                        @if( $users1[0]->community_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Community Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->nationality_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}" height="15px" min-width="100%">&nbsp;&nbsp;&nbsp;Nationality Certificate</td>
                        </tr>
                        @endif
                        <tr>
                           <td id="line" colspan="6">
                  ...
                  <div class="col-md-12">
                     ...
                     <thead>
                        ...
                        @if( $users1[0]->fc_confirmation_receipt == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"  src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;eScutiny Centre Confirmation</td>
                        </tr>
                         @endif
                        @if( $users1[0]->dte_allotment_letter == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;DTE Allotment Letter</td>
                        </tr>
                        @endif
                        <!--@if( $users1[0]->arc_ackw_receipt == 'Yes')-->
                        <!--<tr>-->
                        <!--   <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;ARC Acknowledgement</td>-->
                        <!--</tr>-->
                        <!--@endif-->
                        
                        @if( $users1[0]->ssc_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;SSC Marksheet</td>
                        </tr>
                        @endif
                        
                        @if( $users1[0]->hsc_diploma_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;HSC Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->first_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Diploma First Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->second_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Diploma Second Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->third_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Diploma Third Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->fourth_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Diploma fourth Year Marksheet</td>
                        </tr>
                        @endif
                        <!--@if( $users1[0]->convocation_passing_certi == 'Yes')-->
                        <!--<tr>-->
                        <!--   <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Convocation/passing Certificate</td>-->
                        <!--</tr>-->
                        <!--@endif-->

                        @if( $users1[0]->equivalent_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Equivalent Certificate</td>
                        </tr>
                        @endif
                        ...
                        @if( $users1[0]->degree_leaving_tc == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Diploma Leaving Certificate</td>
                        </tr>
                        @endif 
                         
                        @if( $users1[0]->migration_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Migration Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->birth_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Birth Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->domicile == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Domicile Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_o == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Proforma O</td>
                        </tr>
                        @endif
                        @if( $users1[0]->retention == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Retention Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->minority_affidavit == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Minority Affidavit</td>
                        </tr>
                        @endif
                        @if( $users1[0]->gap_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Gap Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->community_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Community Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Caste Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_validity_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Caste Validity Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->non_creamy_layer_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Non-Creamy Layer Certificate</td>
                        </tr>
                        @endif
                         @if( $users1[0]->income_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Income Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->nationality_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Nationality Certificate</td>
                        </tr>
                        @endif
                        
                        @if( $users1[0]->proforma_c_d_e == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Proforma C D E</td>
                        </tr>
                        @endif
                        
                        @if( $users1[0]->medical_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Physical Fitness Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->anti_ragging_affidavit == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:10px;"><img class="img-responsive"style="height:10px;"   src="{{ asset('public/images/glyphicon-ok.jpg') }}" height="15px" min-width="100%" >&nbsp;&nbsp;&nbsp;Anti Ragging Certificate</td>
                        </tr>
                        @endif
                        <tr>
                           <td id="line" colspan="6">
                ...
                <div style="float:left;">
                    ...
                    <div style="margin-left:185px;"><img style="height:50px;margin-top:-30px;" max-width="100%" src="{{ asset('public/images/asmasign.jpg') }}"></div>
