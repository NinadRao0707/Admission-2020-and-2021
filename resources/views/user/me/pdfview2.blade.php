...
<html>
   <head>
      <title>{{ "ME_ACAP_".$users1[0]->name_on_marksheet }}</title>
      <style>
         th {
         text-align: left;
         }
   ...
   <body>
      <!-------------------------------------------Page 1-------------------------------------------------->
       <div class="container">
         <div class="col-md-12">
           <center><img class="img-responsive" src="{{ asset('public/images/acap_header_me_admissionForm.jpg') }}"></center>
         </div>
         <!-- <div class="col-md-12">
                      ...
                      @endif
                       <tr>
                        ...
                        <tr>
                           ...
                           <td id="hide">&nbsp;Allotted in CAP Round</td>
...
<!-------------------------------------------Previous details-------------------------------------------------->
                        ...
                        <tr>
                           ...
                           <td id="hide" style="text-align: center;">Month & Year of Passing</td>
                           <td id="hide" style="text-align: center;">Sem 1 Marks</td>
                           <td id="hide" style="text-align: center;">Sem 2 Marks</td>
                           <td id="hide" style="text-align: center;">Sem 3 Marks</td>
                           <td id="hide" style="text-align: center;">Sem 4 Marks</td>
                        </tr>
                        <tr>
                           <td id="data" style="text-align: center;">&nbsp;{{ $users1[0]->degree_university }} -{{ $users1[0]->university_type }} - {{ $users1[0]->degree_college_name }} - {{$users1[0]->degree_name}} - {{$users1[0]->degree_branch}}</td>
                           <td id="data" style="text-align: center;">&nbsp;{{ $users1[0]->degree_passing_month }} {{ $users1[0]->degree_passing_year }}</td>
                           <td id="data" style="text-align: center;">&nbsp;{{ $users1[0]->degree_sem_1_obt_marks }} / {{ $users1[0]->degree_sem_1_max_marks }}</td>
                           <td id="data" style="text-align: center;">&nbsp;{{ $users1[0]->degree_sem_2_obt_marks }} / {{ $users1[0]->degree_sem_2_max_marks }}</td>
                           <td id="data" style="text-align: center;">&nbsp;{{ $users1[0]->degree_sem_3_obt_marks }} / {{ $users1[0]->degree_sem_3_max_marks }}</td>
                           <td id="data" style="text-align: center;">&nbsp;{{ $users1[0]->degree_sem_4_obt_marks }} / {{ $users1[0]->degree_sem_4_max_marks }}</td>
                        </tr>
                        <tr>

                           <td id="hide" style="text-align: center;">Sem 5 Marks</td>
                           <td id="hide" style="text-align: center;">Sem 6 Marks</td>
                           <td id="hide" style="text-align: center;">Sem 7 Marks</td>
                           <td id="hide" style="text-align: center;">Sem 8 Marks</td>
                        </tr>
                        
                        <tr>
                           
                           <td id="data" style="text-align: center;">&nbsp;{{ $users1[0]->degree_sem_5_obt_marks }} / {{ $users1[0]->degree_sem_5_max_marks }}</td>
                           <td id="data" style="text-align: center;">&nbsp;{{ $users1[0]->degree_sem_6_obt_marks }} / {{ $users1[0]->degree_sem_6_max_marks }}</td>
                           <td id="data" style="text-align: center;">&nbsp;{{ $users1[0]->degree_sem_7_obt_marks }} / {{ $users1[0]->degree_sem_7_max_marks }}</td>
                           <td id="data" style="text-align: center;">&nbsp;{{ $users1[0]->degree_sem_8_obt_marks }} / {{ $users1[0]->degree_sem_8_max_marks }}</td>
                        </tr>
                        @else
                        <tr>
                           <td id="hide" style="text-align: center;">University(Type) & Name of College & Degree & Branch</td>
