...
<noscript>
 ...
 <body onload = "blocking('{{$user1[0]->resident_of}}')" id="example">
 <!--nav start-->
<!--   <header style="position: fixed;right: 1px; top: 80px; width: 100% !important;z-index: 1;">
            ...
            <nav id="menu" style="background-color: #204a84;">
              ...
              <div class="col-md" >
                <div class="abc">
                    <li class="active"><a href="{{ route('me_contact_details') }}" ><i class="fa fa-fw fa-home"></i>Contact Details&nbsp</a></li>
              </div>
              </div>
...
<div class="container">
     ...
     <!--  <div class="row-md-8">
        <aside>
          <div class="list-group">
            ...
            <a href="{{ route('me_contact_details') }}" class="list-group-item active">
  ...
  <script type="text/javascript">
    ...
    <div class="col-md-12 col-sm-12">
      ...
      <h1>Contact Details&nbsp;&nbsp;&nbsp;<label class="btn btn-sm btn-danger" data-toggle="modal" data-target="#dteContact" id="myBtn"  onclick="myFunction()" style="font-weight: bold; border-radius: 100px">?</label></h1>
        <script>
function myFunction() {
  var a=document.getElementById("dteContact");
   a.classList.add("fade");
      ...
      @endif
      <!---------------------------------Modal Close------------------------------------------>
      <form method="post" action="{{ route('me_contact_details') }}">
        {{ csrf_field() }}
        ...
        <div class="form-group col-md-6 col-sm-12">
          <label for="permanentAddressLine2">Address Line 2<label style="color: #eee; font-size: 25px;vertical-align: sub;">*</label></label>
...
<script type="text/javascript">
        ...
        <div class="fsorm-group col-md-12 col-sm-12">
        ...
        <div class="form-group col-md-6 col-sm-12">
          ...
          <input type="text" class="form-control" id="currentAddressLine1" name="currentAddressLine1" value="{{$user1[0]->correspondance_address_line1}}" placeholder="Address Line 1" <?php if( $permanent == "true") echo 'readonly' ?> required>
         
        </div>
        <div class="form-group col-md-6 col-sm-12">
          <label for="currentAddressLine2">Address Line 2<label style="color: #eee; font-size: 25px;vertical-align: sub;">*</label></label>
          <input type="text" class="form-control" id="currentAddressLine2" name="currentAddressLine2" value="{{$user1[0]->correspondance_address_line2}}" placeholder="Address Line 2" <?php if( $permanent == "true") echo 'readonly' ?> required>
         
        </div>
        <div class="form-group col-md-4 col-sm-12">
          <label for="currentAddressCity">City<label style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
          <input type="text" class="form-control" id="currentAddressCity" name="currentAddressCity" value="{{$user1[0]->correspondance_city}}" placeholder="Enter City" <?php if( $permanent == "true") echo 'readonly' ?> required>
        ...
        <div class="form-group col-md-4 col-sm-12">
          ...
          <input type="text" class="form-control" id="currentAddressDistrict" name="currentAddressDistrict" value="{{$user1[0]->correspondance_district}}" placeholder="Enter District" <?php if( $permanent == "true") echo 'readonly' ?> required>
        ...
        <div class="form-group col-md-4 col-sm-12">
          ...
          <input type="text" class="form-control" id="currentAddressState" name="currentAddressState" value="{{$user1[0]->correspondance_state}}" placeholder="Enter State" <?php if( $permanent == "true") echo 'readonly' ?> required>
        ...
        <div class="form-group col-md-6 col-sm-12">
          ...
          <input type="text" oninput="checkcurrentaddresspin()" onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" maxlength="6" class="form-control" id="currentAddressPincode" name="currentAddressPincode" value="{{$user1[0]->correspondance_pincode}}"  placeholder="Pincode" <?php if( $permanent == "true") echo 'readonly' ?> required>
          <script type="text/javascript">
          ...
          if(currentAddressPincode.value!=""){   
            ...
            $("#currentAddressPincode").on("invalid", function (event) {
            event.target.setCustomValidity('Enter proper pincode')
        ...
        <div class="form-group col-md-6 col-sm-12">
          ...
          <input type="text" class="form-control" id="currentAddressNearestRailwayStation" name="currentAddressNearestRailwayStation" value="{{$user1[0]->correspondance_nearest_rail_station}}"  placeholder="Nearest Railway Station" <?php if( $permanent == "true") echo 'readonly' ?> required>
        ...
        <div class="form-group col-md-12 col-sm-12">
          ...
          <input type="radio" id="localOutstationL" name="localOutstation" value="Local" onclick="notLocal()">Local &nbsp
        ...
        <div class="form-group col-md-6 col-sm-12">
          <label for="localGuardianAddressLine2">Address Line 2<label style="color: #eee; font-size: 25px;vertical-align: sub;">*</label></label>
        ...
        <div class="form-group col-md-3 col-sm-12">
          ...
          <input type="text" class="form-control" oninput="checkguardianaddresspin()" onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" maxlength="6" id="localGuardianAddressPincode" name="localGuardianAddressPincode" value="{{$user1[0]->local_guardian_pincode}}"  placeholder="Pincode" <?php if( $user1[0]->resident_of == "Local") echo 'disabled' ?>>
 ...
 <script type="text/javascript">
        ...
        <div class="form-group col-md-6 col-sm-12">
          <a  href="{{ route('me_guardian_details') }}">
