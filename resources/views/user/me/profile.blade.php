...
<p style="list-style-type:square;"><b>Note : To participate in the Against CAP admission process, the candidate has to pay Rs 1000+Rs180 (GST).The payment link will be activated  on  29/01/2021 to 31/01/2021.</b></p>
      ...
      @foreach ($dtes as $dte)
              ...
              @endforeach
              <tr>
                    <td style=" " colspan="3" > NOTE : THE PAYMENT LINK WILL BE ACTIVATED ON <strong>29<sup>th</sup> JAN </strong>(AFTER 11.59AM) TO <strong>31<sup>st</sup>JAN</strong> (TILL 4.00PM )  </td>
