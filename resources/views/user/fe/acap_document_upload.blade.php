                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <font style="font-weight: bold;">For Documents marked with <font style="color: red;">*</font><p style="color: red"> (only .pdf) </p> :</font> These documents need to be uploaded when you are filling the form.<br>
                ...
                <td>
                  ...
                  <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            <div class="modal-header">
                              <h4 class="modal-title">eScrutiny Centre Confirmation Receipt-cum-Acknowledgement for Admission</h4>
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <div class="modal-body">
