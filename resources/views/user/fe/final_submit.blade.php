...
<div class="container">
         ...
         <!-- <div class="row-md-8">
            <aside>
               <div class="list-group">
                  ...
                  @endif
                  <a href="{{ route('fe_final_submit') }}" class="list-group-item active">
   ...
   <div class="col-md-12 col-sm-12" style="margin-left: 5%; margin-right: 5%;" >
      <h1>Final Submission</h1>
      <form method="post" action="{{ route('fe_final_submit') }}">
         {{ csrf_field() }}
         ...
         <div class="form-group col-md-10">
            <a href="{{ route('fe_final_submit') }} ">
              @if($check[0]->is_dte_details_completed == 1 && $check[0]->is_academic_completed == 1 && $check[0]->is_personal_completed == 1 && $check[0]->is_guardian_completed == 1 && $check[0]->is_contact_completed == 1 && $check[0]->is_document_completed == 1 && $payment[0]->balance_amt == 0)
               <button type="submit" class="btn btn-primary pull-left btn-view" id="submit" namca="submit" style="width: 100%" >Submit</button>
               @else
