            ...
            <div class="modal-body">
              ...
              <table class="table table-striped table-bordered" id="academic_modal">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>3</td>
                    <td>eScrutiny Centre Confirmation Receipt-cum-Acknowledgement for Admission</td>
                  </tr>
                  <tr>
                    <td>4</td>
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            <div id="dteDocs">
              ...
              <tr>
                <td>3</td>
                <td>SC Confirmation Reciept(eScrutiny form/revise acknowledgement form)<font> *</font><p style="color: red"> (only .pdf) </p></td>
              ...
              <tr style="display:none;">
                <td>5</td>
                <td>ARC Acknowledgement<font> *</font><p style="color: red"> (only .pdf) </p></td>
            ...
            <tr>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="jee_result" name="jee_result">
            ...
            <tr>
              ...
              <td>
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <embed src="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->hsc_leaving_certi_path) }}" width="1200px" height="770px" /> change -->
                               <object data="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->hsc_leaving_certi_path) }}" type="application/pdf" width="95%" height="700">
                            <embed src="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->hsc_leaving_certi_path) }}" width="1200px" height="770px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="degree_leaving_tc" name="hsc_leaving_certi">
            ...
            <tr style="display:none">
              ...
              @if( $user1[0]->hsc_passing_certi == 'Yes')
                ...
                <td>
                  <font style="font-size: 10px">Mandatory only for other than maharashtra state board</font>
                </td>
              @else
                <td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="convocation_passing_certi" name="hsc_passing_certi">
                          ...
                          <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                              ...
                              <embed src="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->migration_certi_path) }}" width="1200px" height="770px" /> change-->
                                <object data="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->migration_certi_path) }}" type="application/pdf" width="100%" height="700">
            ...
            <tr>
              <td>15</td>
              <td>
                    Aadhar Card<font> *&nbsp;</font><p style="color: red"> (only .pdf) </p><br>
              ...
              <td>
                ...
                <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->aadhar_path) }}" type="application/pdf" width="95%" height="700">
                            <embed src="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->aadhar_path) }}" width="1200px" height="770px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="aadhar" name="aadhar">
            ...
            <tr>
              <td>21</td>
              <td>Caste Certificat<p style="color: red"> (only .pdf) </p>e</td>
            ...
            <tr>
              <td>25</td>
              <td>Proforma G1 G2<p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                 ...
                 <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->proforma_g1_g2_path) }}" type="application/pdf" width="95%" height="700">
                            <embed src="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->proforma_g1_g2_path) }}" width="1200px" height="770px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="proforma_g1_g2" name="proforma_g1_g2">
           ...
           {{-- Proforma U --}}
            ...
            <tr>
              <td>28</td>
              <td>Proforma J K L<p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="proforma_j_k_l" name="proforma_j_k_l">
