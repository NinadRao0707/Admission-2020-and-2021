    ...
    <body onload="radiocheck('{{ $user1[0]->is_cet }}','{{ $user1[0]->is_jee }}')">
        ...
        <div class="progress-bar progress-bar-striped active"  id="myDIV"style="width:0%; background-color:#204a84;">
         ...
         -->
                ...
                <h1>Academic Details&nbsp;&nbsp;&nbsp;<label class="btn btn-sm btn-danger" data-toggle="modal"
                        onclick="myFunction()" data-target="#dteAccademic" id="myBtn"
                        style="font-weight: bold; border-radius: 100px">?</label></h1>
                <script>
                    function myFunction() {
                ...
                <form method="post" action="{{ route('fe_academic_details') }}">
                    ...
                    <div class="form-group col-md-12 col-sm-12">
                        <center>
                            <h4 style="font-weight: bold;  background-color: #204a84; color=" red">Do not use ' (apostrophe)
                                inside any fields</h4>
                        </center>
                    </div>
                    <div class="form-group col-md-12 col-sm-12">
                        <label for="dteId">DTE ID</label>
                        <input type="text" class="form-control" id="dteId" name="dteId" value="{{ $user1[0]->dte_id }}"
                            placeholder=" DTE ID" disabled>
                    </div>
                    <div id="sscDetails">
                        <fieldset id="fieldset">
                            <legend align="top" style="font-weight: bold">10th / Equivalent Details</legend>

                            {{-- school name --}}
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="sscSchool">School name<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" class="form-control" id="sscSchool" name="sscSchool"
                                    value="{{ $user1[0]->x_school_name }}" required placeholder="Enter School name">

                                <script type="text/javascript">
                                    document.getElementById("sscSchool").onkeypress = function(e) {
                                        var e = window.event || e
                                        var keyunicode = e.charCode || e.keyCode
                                        return (keyunicode >= 65 && keyunicode <= 90 || keyunicode >= 97 && keyunicode <= 122 || keyunicode == 8 ||
                            ...
                            {{-- school city --}}
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="sscCity">School City<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" class="form-control" id="sscCity" name="sscCity"
                                    value="{{ $user1[0]->x_school_city }}" required placeholder="Enter School City">
                            ...
                            {{-- school State --}}
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="sscState">School State<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" class="form-control" id="sscState" name="sscState"
                                    value="{{ $user1[0]->x_school_state }}" required placeholder="Enter School State">
                            ...
                            {{-- passing month --}}
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="xPassingMonth">Month of Passing<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                            ...
                            {{-- passing year --}}
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="xPassingYear">Year of Passing<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                            ...
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="sscBoard">Board Name<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" class="form-control" id="sscBoard" name="sscBoard"
                                    value="{{ $user1[0]->x_board }}" required placeholder="Enter Board name">
                            ...
                            <div class="form-group col-md-3 col-sm-12   ">
                                <label for="sscBoardNumber">Seat Number<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" class="form-control" id="sscBoardNumber" name="sscBoardNumber"
                                    value="{{ $user1[0]->x_board_seat_no }}" onkeypress="return checkSpcialChar(event);"
                                    maxlength="20" required placeholder="Enter Seat No">
                                <script type="text/javascript">
                            ...
                            {{-- obtain marks --}}
                            <div class="form-group col-md-3 col-sm-12">
                                <label for="xObtainedMarks">Obtained Marks<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" maxlength="4"
                                    class="form-control" id="xObtainedMarks" name="xObtainedMarks"
                                    value="{{ $user1[0]->x_obtained_marks }}" required placeholder="Enter Obtained Marks"
                                    onblur="xpercent()">
                            ...
                            {{-- total marks --}}
                            <div class="form-group col-md-3 col-sm-12">
                                <label for="xTotalMarks">Total Marks<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" class="form-control" id="xTotalMarks" name="xTotalMarks"
                                    onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" maxlength="4"
                                    value="{{ $user1[0]->x_max_marks }}" required placeholder="Enter Total Marks"
                                    onblur="xpercent()">
                            </div>
                            ...
                            <div class="form-group col-md-3 col-sm-12">
                                <label for="xPercentage">Percentage<label
                                        style="color: #eee; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="number" class="form-control" id="xPercentage" name="xPercentage"
                                    value="{{ $user1[0]->x_percentage }}" placeholder="Percentage" readonly="readonly"
                                    required>
                            </div>
                            {{-- close percentage --}}
                            ...
                            <div id="xpercent">
                                <script type="text/javascript">
                                    function xpercent() {
                                        var obtxmarks = parseInt(document.getElementById('xObtainedMarks').value);
                                        var maxxmarks = parseInt(document.getElementById('xTotalMarks').value);
                                        if (obtxmarks != null && maxxmarks != null) {
                                            if (obtxmarks > maxxmarks) {
                                                alert("Obtained Class X marks are more than total marks");
                                                document.getElementById('xObtainedMarks').value = '';
                                                document.getElementById('xObtainedMarks').focus();
                                                e.preventDefault();
                                            } else {
                                                var p = (obtxmarks / maxxmarks) * 100;
                    ...
                    <div id="hscDetails">
                        <fieldset id="fieldset">
                            ...
                            {{-- College name --}}
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="hscCollege">College name<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" class="form-control" id="hscCollege" name="hscCollege"
                                    value="{{ $user1[0]->xii_college_name }}" required placeholder="Enter College name">
                            ...
                            {{-- College city --}}
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="hscCity">College City<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" class="form-control" id="hscCity" name="hscCity"
                                    value="{{ $user1[0]->xii_college_city }}" required placeholder="Enter College City">
                            ...
                            {{-- College State --}}
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="hscState">College State<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" class="form-control" id="hscState" name="hscState"
                                    value="{{ $user1[0]->x_school_state }}" required placeholder="Enter School State">
                     ...
                     <script type="text/javascript">
                         document.getElementById("sscState").onkeypress = function(e) {
                            ...
                            {{-- passing month --}}
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="hscMonth">Month of Passing<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
            ...
            {{-- passing year --}}
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="xiiPassingYear">Year of Passing<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                ...
                                <select id="xiiPassingYear" onchange="checkyear()" name="xiiPassingYear"
                            ...
                            <script type="text/javascript">
                                ...
                                function checkyear() {
                                    if (document.getElementById('xiiPassingYear').value < document.getElementById('xPassingYear').value) {
                                        alert("12th passing year invalid");

                                    }
                                    // console.log(document.getElementById('xiiPassingYear').value);
                            ...
                            <div class="form-group col-md-4 col-sm-12">
                                ...
                                <select class="form-control" id="hscBoard" onclick="other()" name="hscBoard" required>
                                    @foreach ($university_types as $key => $universityname)
                                        @if ($user1[0]->xii_board == $key)
                                            <option value={{ $key }} id="selected" selected>
                                                {{ $universityname }}
                                            </option>
                                        @endif
                                        @if ($user1[0]->xii_board != $key)
                                ...
                                <div id="hscotherBoard1" class="form-group col-md-12 col-sm-12">
                                    <label for="hscState">College Board name<label
                                            style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                    <input type="text" class="form-control" id="hscotherBoard" name="hscotherBoard"
                                        value="{{ $user1[0]->xii_board }}" placeholder="Enter Board name">
                            ...
                            {{-- Board Seat No --}}
                            <div class="form-group col-md-3 col-sm-12">
                                <label for="hscBoardNumber">Seat Number<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" class="form-control" id="hscBoardNumber" name="hscBoardNumber"
                                    value="{{ $user1[0]->xii_board_seat_no }}" maxlength="20"
                                    onkeypress="return checkSpcialChar(event);" required placeholder="Enter HSC Seat Number"
                                    required>
                            ...
                            <div class="form-group col-md-3 col-sm-12">
                                <label for="xiiObtainedMarks">Obtained Marks<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" class="form-control" id="xiiObtainedMarks" name="xiiObtainedMarks"
                                    value="{{ $user1[0]->xii_obtained_marks }}"
                                    onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" maxlength="3"
                                    placeholder="Obtained Marks" onblur="xiipercent()" required>

                            </div>


                            <div class="form-group col-md-3 col-sm-12">
                                <label for="xiiMaximumMarks">Total Marks<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" class="form-control" id="xiiMaximumMarks" name="xiiMaximumMarks"
                                    value="{{ $user1[0]->xii_max_marks }}"
                                    onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" maxlength="3"
                                    placeholder="Maximum Marks" onblur="xiipercent()" required>
                            ...
                            <div class="form-group col-md-3 col-sm-12">
                                <label for="xiiPercentage">Percentage<label
                                        style="color: #eee; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="number" class="form-control" id="xiiPercentage" name="xiiPercentage"
                                    value="{{ $user1[0]->xii_percentage }}" placeholder="Percentage" readonly="readonly"
                                    maxlength="5" required>
                            </div>
                            <div id="xiipercent">
                                <script type="text/javascript">
                                    function xiipercent() {
                                        var obtxiimarks = parseInt(document.getElementById('xiiObtainedMarks').value);
                                        var maxxiimarks = parseInt(document.getElementById('xiiMaximumMarks').value);
                                        if (obtxiimarks != null && maxxiimarks != null) {
                                            if (obtxiimarks > maxxiimarks) {
                                                alert("Obtained Class XII marks are more than total marks");
                                                document.getElementById('xiiObtainedMarks').value = '';
                                                document.getElementById('xiiObtainedMarks').focus();
                                                e.preventDefault();
                                            } else {
                                                var p = (obtxiimarks / maxxiimarks) * 100;
                    ...
                    <div id="mathsMarks">
                        ...
                        <fieldset id="fieldset">
                            ...
                            <div class="form-group col-md-6 col-sm-12" style="margin-top: -10px;">
                                ...
                                <input type="text" class="form-control" id="hscMathsObtainMarks" name="hscMathsObtainMarks"
                                    value="{{ $user1[0]->xii_maths_obtained_marks }}"
                                    onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" maxlength="3"
                                    placeholder="Enter Obtained Marks" onblur="calAggr()" required>
                            </div>
                            <div class="form-group col-md-6 col-sm-12" style="margin-top: -10px;">
                                <label for="hscMathsMaxMarks">Total Marks <label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label>
                                </label>
                                <input type="text" class="form-control" id="hscMathsMaxMarks" name="hscMathsMaxMarks"
                                    value="{{ $user1[0]->xii_maths_max_marks }}"
                                    onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" maxlength="3"
                                    placeholder="Enter Total Marks" onblur="calAggr()" required>
                            </div>
                    ...
                    <div id="PhysicsMarks">
                        ...
                        <fieldset id="fieldset">
                            ...
                            <div class="form-group col-md-6 col-sm-12" style="margin-top: -10px;">
                                ...
                                <input type="text" class="form-control" id="hscPhysicsObtainMarks"
                                    name="hscPhysicsObtainMarks" value="{{ $user1[0]->xii_physics_obtained_marks }}"
                                    onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" maxlength="3"
                                    placeholder="Enter Obtained Marks" onblur="calAggr()" required>
                            </div>
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="hscPhysicsMaxMarks" name="hscPhysicsMaxMarks"
                                    value="{{ $user1[0]->xii_physics_max_marks }}"
                                    onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" maxlength="3"
                                    placeholder="Enter Total Marks" onblur="calAggr()" required>
                            </div>
                    ...
                    <div id="ChemistryMarks">
                        <fieldset id="fieldset">
                            ...
                            <div class="form-group col-md-6 col-sm-12" style="margin-top: -10px;">
                                ...
                                <input type="text" class="form-control" id="hscChemistryObtainMarks"
                                    name="hscChemistryObtainMarks" value="{{ $user1[0]->xii_chemistry_obtained_marks }}"
                                    onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" maxlength="3"
                                    placeholder="Enter Obtained Marks" onblur="calAggr()" required>
                            </div>
                            ...
                            <div class="form-group col-md-6 col-sm-12" style="margin-top: -10px;">
                                ...
                                <input type="text" class="form-control" id="hscChemistryMaxMarks"
                                    name="hscChemistryMaxMarks" value="{{ $user1[0]->xii_chemistry_max_marks }}"
                                    onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" maxlength="3"
                                    placeholder="Enter Total Marks" onblur="calAggr()" required>
                            </div>
                    ...
                    <div id="AggregateDetails" class="col-md-12 col-sm-12">
                        <fieldset id="fieldset">
                            ...
                            <div class="form-group col-md-12 col-sm-12" style="margin-top: -10px;">
                                <label for="hscAggregateMarks">Aggregate Marks of PCM<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label>
                                </label>
                                <input type="text" class="form-control" id="hscAggregateMarks" name="hscAggregateMarks"
                                    value="{{ $user1[0]->xii_aggregate_marks }}" placeholder="Enter Aggregate Marks"
                    ...
                    <div id="vocationalSubjects1">
                        <fieldset id="fieldset">
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="hscVocationalSubject1">Select Subject<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <select id="hscVocationalSubject1" name="hscVocationalSubject1"
                                    value="{{ $user1[0]->xii_vocational_subject1 }}" class="form-control" required>
                                    @foreach ($vocational_subjects as $key => $vocational_subject)
                                        @if ($user1[0]->xii_vocational_subject1 == $key)
                                            <option value="{{ $key }}" selected>{{ $vocational_subject }}
                                            </option>
                                        @endif
                                        @if ($user1[0]->xii_vocational_subject1 != $key)
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="hscVocationalSubject1Code"
                                    name="hscVocationalSubject1Code"
                                    value="{{ $user1[0]->xii_vocational_subject1_code }}"
                                    placeholder="Enter Vocational Subject Code" required>
                            </div>
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="hscVocationalSubject1MaxMarks"
                                    name="hscVocationalSubject1MaxMarks" maxlength="3"
                                    onblur="calAggr()"
                                    value="{{ $user1[0]->xii_vocational_subject1_max_marks }}"
                                    onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))"
                                    placeholder="Enter Vocational Subject Total Marks" required>
                            </div>
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="hscVocationalSubject1ObtainMarks"
                                    onblur="calAggr()"
                                    name="hscVocationalSubject1ObtainMarks" maxlength="3"
                                    value="{{ $user1[0]->xii_vocational_subject1_obtained_marks }}"
                                    onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))"
                                    placeholder="Enter Vocational Subject Obtained Marks" required>
                            </div>
                            <script type="text/javascript">
                            ...
                            <div id="Aggr">
                                <script type="text/javascript">
                                    function calAggr() {
                                        ...
                                        var obtVoc = parseInt(document.getElementById('hscVocationalSubject1ObtainMarks').value);
                                        var MaxVoc = parseInt(document.getElementById('hscVocationalSubject1MaxMarks').value);
                                        if (obtMaths > MaxMaths) {
                                            alert("Obtained Maths marks are more than total marks");
                                            document.getElementById('hscMathsObtainMarks').value = '';
                                            document.getElementById('hscMathsObtainMarks').focus();
                                        }
                                        if (obtPhy > MaxPhy) {
                                            alert("Obtained Physics marks are more than total marks");
                                            document.getElementById('hscPhysicsObtainMarks').value = '';
                                            document.getElementById('hscPhysicsObtainMarks').focus();
                                        }
                                        if (obtChem > MaxChem) {
                                            alert("Obtained Chemistry marks are more than total marks");
                                            document.getElementById('hscChemistryObtainMarks').value = '';
                                            document.getElementById('hscChemistryObtainMarks').focus();
                                        }
                                        if (obtVoc > MaxVoc) {
                                            alert("Obtained Vocational marks are more than total marks");
                                            document.getElementById('hscVocationalSubject1ObtainMarks').value = '';
                                            document.getElementById('hscVocationalSubject1ObtainMarks').focus();
                                        }
                    ...
                    @if ($user1[0]->is_cet == '1')
                        <input type="radio" value="yes" name="isCet" id="cetY" onclick="yesnoCet()" checked="checked" />
                        Yes&nbsp;&nbsp;
                    ...
                    <div id="cetSection">
                        <fieldset id="fieldset">
                            ...
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="cetSeatNumber">CET Seat Number<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label>
                                </label>
                                <input type="" class="form-control" id="cetSeatNumber" name="cetSeatNumber"
                                    value="{{ $user1[0]->cet_seat_no }}" required pattern="([A-z0-9À-ž\s]){2,}"
                                    placeholder="Enter CET Seat Number">
                            </div>

                            <div class="form-group col-md-4 col-sm-12">
                                <label for="cetYear">Year<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                            ...
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="cetMonth">Month<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                        ...
                        <fieldset id="fieldset">
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="cetMathsScore">Mathematics Percentile<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" step="any" class="form-control" id="cetMathsScore" onblur="cetmathpercentile()"
                                    onKeyUp="$(this).val($(this).val().replace(/[^0-9\\.]+/g, ''))" name="cetMathsScore"
                                    value="{{ $user1[0]->cet_maths }}" maxlength="20"
                                    placeholder="CET Mathematics Percentile">
                            </div>
                            
                            <script type = "text/javascript">
                            function cetmathpercentile()
                            {
                                var o = parseInt(document.getElementById('cetMathsScore').value);
                                if (o > 100)
                                {
                                    alert("Maths CET Percentile is greater than 100");
                                    document.getElementById('cetMathsScore').value = 0;
                                    e.preventDefault();
                                }
                            }
                            </script>
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="cetPhysicsScore">Physics Percentile<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" step="any" class="form-control" id="cetPhysicsScore" onblur="cetphypercentile()"
                                    onKeyUp="$(this).val($(this).val().replace(/[^0-9\\.]+/g, ''))" name="cetPhysicsScore"
                                    value="{{ $user1[0]->cet_physics }}" maxlength="20"
                                    placeholder="CET Physics Percentile">
                            </div>

                            <script type = "text/javascript">
                            function cetphypercentile()
                            {
                                var o = parseInt(document.getElementById('cetPhysicsScore').value);
                                if (o > 100)
                                {
                                    alert("Physics CET Percentile is greater than 100");
                                    document.getElementById('cetPhysicsScore').value = 0;
                                    e.preventDefault();
                                }
                            }
                            </script>
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="cetChemistryScore">Chemistry Percentile<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" step="any" class="form-control" id="cetChemistryScore" onblur="cetchempercentile()"
                                    onKeyUp="$(this).val($(this).val().replace(/[^0-9\\.]+/g, ''))" name="cetChemistryScore"
                                    value="{{ $user1[0]->cet_chemistry }}" maxlength="20" 
                                    placeholder="CET Chemistry Percentile">
                            </div>

                            <script type = "text/javascript">
                            function cetchempercentile()
                            {
                                var o = parseInt(document.getElementById('cetChemistryScore').value);
                                if (o > 100)
                                {
                                    alert("Chemistry CET Percentile is greater than 100");
                                    document.getElementById('cetChemistryScore').value = 0;
                                    e.preventDefault();
                                }
                            }
                            </script>
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="cetScore">CET Percentile<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label><label
                                        style="color: red; font-size: 13px;vertical-align: sub;">(Enter the complete
                                        percentile upto 7 decimal places)</label></label>
                                        <input type="text" step="any" class="form-control" id="cetScore" onblur="cetfinalpercentile()"
                                        onKeyUp="$(this).val($(this).val().replace(/[^0-9\\.]+/g, ''))" name="cetScore"
                                        value="{{ $user1[0]->cet_score }}" placeholder="CET Percentile">
                            ...
                            <script type = "text/javascript">
                            function cetfinalpercentile()
                            {
                                var o = parseInt(document.getElementById('cetScore').value);
                                if (o > 100)
                                {
                                    alert("CET Percentile is greater than 100");
                                    document.getElementById('cetScore').value = 0;
                                    e.preventDefault();
                                }
                            }
                            </script>
                    ...
                    &nbsp;&nbsp;&nbsp;
                    @if ($user1[0]->is_jee == '1')
                        <input type="radio" id="jeeY" value="yes" name="isJee" onclick="yesnoJee()" checked />
                        Yes&nbsp;&nbsp;
                    ...
                    <div id="jeeSection">
                        <fieldset id="fieldset">
                            ...
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="jeeSeatNumber">JEE Seat Number<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                                <input type="text" class="form-control" id="jeeSeatNumber" name="jeeSeatNumber"
                                    value="{{ $user1[0]->jee_seat_no }}" maxlength="20" required
                                    pattern="([A-z0-9À-ž\s]){2,}" placeholder="Enter JEE Seat Number">
                            </div>

                            <div class="form-group col-md-4 col-sm-12">
                                <label for="jeeYear">Year<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                            ...
                            <div class="form-group col-md-4 col-sm-12">
                                <label for="jeeMonth">Month<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
                        ...
                        <fieldset id="fieldset">
                            ...
                            <legend align="top" style="font-weight: bold">Enter Subject Marks</legend>
                            <div class="form-group col-md-3 col-sm-12">
                                <label for="jeeMathsScore">Mathematics Score<label
                                        style="color: red; font-size: 25px;vertical-align: all;">*</label></label>
                                <input type="text" class="form-control" id="jeeMathsScore"
                                    onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" name="jeeMathsScore"
                                    value="{{ $user1[0]->jee_maths_score }}" maxlength="4" max="1000" min="-120"
                                    placeholder="JEE Mathematics Score" onblur="JEETot()">
                            </div>

                            <div class="form-group col-md-3 col-sm-12">
                                <label for="jeePhysicsScore">Physics Score<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>

                                <input type="text" class="form-control" id="jeePhysicsScore"
                                    onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" name="jeePhysicsScore"
                                    value="{{ $user1[0]->jee_physics_score }}" maxlength="4" max="1000" min="-120"
                                    placeholder="JEE Physics Score" onblur="JEETot()">
                            </div>

                            <div class="form-group col-md-3 col-sm-12">
                                <label for="jeeChemistryScore">Chemistry Score<label
                                        style="color: red; font-size: 25px;vertical-align: all;">*</label></label>
                                <input type="text" class="form-control" id="jeeChemistryScore"
                                    onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" name="jeeChemistryScore"
                                    value="{{ $user1[0]->jee_chemistry_score }}" maxlength="4" max="1000" min="-120"
                                    placeholder="JEE Chemistry Score" onblur="JEETot()">
                            </div>


                            <div class="form-group col-md-3 col-sm-12">
                                <label for="jeeMainsScore">JEE Obtained Score<label
                                        style="color: red; font-size: 25px;vertical-align: sub;">*</label>
                                </label>
                                <input type="text" class="form-control" id="jeeMainsScore"
                                    onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" name="jeeMainsScore"
                                    maxlength="4" max="1000" value="{{ $user1[0]->jee_score }}"
                                ...
                                <script type="text/javascript">
                                 ...
                                 function JEETot()
                                    
                                    {
                                        ...
                                        var Tot = obtMaths + obtPhy + obtChem;
                                        document.getElementById('jeeMainsScore').value = (Tot);
                                    }
                    ...
                    <div class="form-group col-md-6 col-sm-12">
                        <a href="{{ route('fe_dte_details') }} ">
                            <button type="button" class="btn btn-view btn-primary" id="submit" name="submit"
                                style="width: 100%">Back</button>
                        </a>
                    </div>
                    <div class="form-group col-md-6 col-sm-12">
                        <button type="submit" class="btn btn-view btn-primary" id="submitForm" name="submit"
                            style="width: 100%">Save And Continue</button>
                    </div>
            ...
            <script type="text/javascript">
                $(function() {
                    ...
                    $("#submitForm").click(function(e) {
                        ...
                        if ($("input[type='radio'][name='isCet']:checked").val() == 'no' && $(
                                "input[type='radio'][name='isJee']:checked").val() == 'no') {
