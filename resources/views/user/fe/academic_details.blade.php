       ...
       <form method="post"  action="{{ route('fe_academic_details') }}">
        ...
        <div id="ChemistryMarks" >
         ...
         <div id="AggregateDetails" class="col-md-12 col-sm-12">
          ...
          <fieldset id="fieldset">
            <legend align="top" style="font-weight: bold">Vocational Subject
                <div id="tooltip"> &nbsp;&nbsp;&nbsp;<label class="btn btn-sm btn-danger" style="font-weight: bold; border-radius: 100px">?</label>
                    <span id="tooltiptext"> 
                   <p style="font-size: 1rem">1. if you dont have vocational subject code , Please write hiphen(-) in the filed. <br> 
                    2. if you have grades then convert it into percentage as your corresponding University Formula and then write marks accordingly in the corresponding field.</p>
                    </span>
                </div>
            </legend>
