...
function myFunction() {
  var a=document.getElementById("dteGuardian");
   a.classList.add("fade");
    ...
    @endif
    <!---------------------------------Modal Close------------------------------------------>
    <form method="post" action="{{ route('fe_guardian_details') }}">
      {{ csrf_field() }}
       @if(session('error'))
          <center>
      ...
      <div class="form-group  col-md-12 col-sm-12">
        <label style="font-size: 18px;">Husband / Father</label>&nbsp;&nbsp;
      ...
      <div class="form-group col-md-6 col-sm-12">
        ...
        <input type="text" onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" maxlength="10" class="form-control" id="mobile" name="mobile" value="{{$user1[0]->g_mobile}}" oninput="mob()" placeholder="Mobile No" required>
        <script type="text/javascript">
          function mob() {
      ...
      <div class="form-group col-md-4 col-sm-12">
        <label for="office_tel_no" style="margin-top: 11px;">Office Telephone No</label>
        <input type="text" onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" class="form-control" style="margin-top: 11px;" id="office_tel_no" name="office_tel_no" value="{{$user1[0]->g_office_tel_no}}" placeholder="Office Telephone No">
        
      </div>
      <div class="form-group col-md-4 col-sm-12">
              <label for="qualification">Qualification<label style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
              <input type="text" class="form-control" id="qualification" name="qualification" value="{{$user1[0]->g_qualification}}" required placeholder="Qualification" required>
      ...
      <div class="form-group col-md-4 col-sm-12">
        ...
        <input type="text" onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" class="form-control" id="annualIncome" name="annualIncome" value="{{$user1[0]->g_annual_income}}" placeholder="Enter Family Annual Income" required>  
      ...
      <div class="form-group col-md-6 col-sm-12">
        <a  href="{{ route('fe_personal_details') }}">
