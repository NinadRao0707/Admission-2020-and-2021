                  ...
                  <table>
                     <thead>
                        <tr>
                           ...
                           <th id="line" colspan="1"style="text-align: center;">Branch: {{$users1[0]->dte_branch}}</th>
                        ...
                        <tr>
                           ...
                           <td id="data" colspan="1">&nbsp;&nbsp;&nbsp;{{ $users1[0]->uid }}</td>
                        <td id="hide">&nbsp;&nbsp;&nbsp;Email ID</td>
                           <td id="data" colspan="2">&nbsp;&nbsp;&nbsp;{{ $users1['email'] }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr style="margin-top:10px;">
                           ...
                           <td id="data" colspan="4">&nbsp;&nbsp;&nbsp;{{ $users1[0]->permanent_address_line1 }}</td>
                        </tr>
                        <tr>
                           <td id="data" colspan="4">&nbsp;&nbsp;&nbsp;{{ $users1[0]->permanent_address_line2 }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td id="data" colspan="1">&nbsp;&nbsp;&nbsp;{{ $users1[0]->permanent_nearest_rail_station }}</td>
                           <td id="hide"rowspan="1">&nbsp;Caste & Tribe</td>
                           <td id="data" colspan="1">&nbsp;&nbsp;&nbsp;{{ $users1[0]->caste_tribe }}</td>
                           <td id="hide">&nbsp;&nbsp;&nbsp;Mother<br>&nbsp;&nbsp;&nbsp;Tongue</td>
                           <td id="data" colspan="1">&nbsp;&nbsp;&nbsp;{{ $users1[0]->mother_tongue }}</td>
                        </tr>
                        <tr>
                           <td id="hide">&nbsp;&nbsp;&nbsp;Place Of Birth</td>
                           <td id="data" colspan="1">&nbsp;&nbsp;&nbsp;{{ $users1[0]->place_of_birth_city }}, {{ $users1[0]->place_of_birth_state }}</td>
                       ...
                       @if( $users1[0]->student_domicile_appl_no != 0 && $users1[0]->student_domicile_no != 0)
                        ...
                        <tr>
                           ...
                           <td id="hide">&nbsp;&nbsp;&nbsp;Allotted in CAP<br>&nbsp;&nbsp;&nbsp;Round</td>
                        ...
                        <tr>
                           ...
                           <td id="data" colspan="6">&nbsp;&nbsp;&nbsp;Bachelor's of Engineering</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           <td id="line" colspan="6">
                              <p>
                                 ...
                                 <b>{{$users1[0]->dte_branch}}</b> <b>{{$users1['shift_allotted']}}</b> Shift, on my own, in consultation with my parents. 
