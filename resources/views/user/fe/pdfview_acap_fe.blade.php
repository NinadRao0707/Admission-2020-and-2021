...
<html>
   <head>
      <title>{{ "FE_ACAP_ADMISSION_".$users1[0]->name_on_marksheet }}</title>
      <style>
         th {
         text-align: left;
         }
   ...
   <body>
      ...
      <div class="container">
         <div class="col-md-12">
            <center><img class="img-responsive" src="{{ asset('public/images/acap_header_fe_admissionForm.jpg') }}"></center>
         </div>
         <div class="col-md-12">
                  ...
                  <table>
                     <thead>
                       ...
                       @if( $users1[0]->student_domicile_appl_no != 0 && $users1[0]->student_domicile_no != 0)
                        ...
                        @endif
                        @if($users1[0]->student_domicile_date != '1111-11-11')
                        <tr>
                        ...
                        <tr>
                           ...
                           <td id="data">&nbsp;&nbsp;&nbsp;Type - {{ $users1[0]->candidate_type }}</td>
                           <td id="hide">&nbsp;&nbsp;&nbsp;ACAP Category</td>
                           <td id="data">&nbsp;&nbsp;&nbsp;Type - {{ $users1[0]->acap_category }}</td>
                        </tr>
                        <!--<tr>-->
                        ...
                        <tr>
                           ...
                           <td id="data" colspan="6">&nbsp;&nbsp;&nbsp;{{ $users1[0]->g_qualification }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           <td id="line" colspan="6">
                              <p align="justify">
                                 ...
                                 I have filled the Application Form for First Year of Four Years Bachelor Degree Course in Engineering for 
                                 the Academic Year 2020-21. The information given by me in this application is true to the best of my knowledge & belief. 
