...
function myFunction() {
  var a=document.getElementById("dteContact");
   a.classList.add("fade");
      ...
      @endif
      <!---------------------------------Modal Close------------------------------------------>
      <form method="post" action="{{ route('fe_contact_details') }}">
        {{ csrf_field() }}
        ...
        <div class="form-group col-md-4 col-sm-12">
              <label for="City">City<label style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
              <input type="text" class="form-control" id="permanentAddressCity" name="permanentAddressCity" value="{{$user1[0]->permanent_city}}"  placeholder="City" required>
            ...
            <div class="form-group col-md-4 col-sm-12">
              ...
              <input type="text" class="form-control" id="permanentAddressDistrict" name="permanentAddressDistrict" value="{{$user1[0]->permanent_district}}"  placeholder="District" required>
            ...
            <div class="form-group col-md-4 col-sm-12">
              ...
              <input type="text" class="form-control" id="permanentAddressState" name="permanentAddressState" value="{{$user1[0]->permanent_state}}"  placeholder="State" required>
        ...
        <div class="form-group col-md-6 col-sm-12">
          ...
          <input type="text" oninput="chckpin()" onKeyUp="$(this).val($(this).val().replace(/[^\d]/ig, ''))" maxlength="6" class="form-control" id="permanentAddressPincode" name="permanentAddressPincode" value="{{$user1[0]->permanent_pincode}}"  placeholder="Enter Pincode" required>
          <script type="text/javascript">
          function checkpin(){     
        ...
        <div class="form-group col-md-4 col-sm-12">
          ...
          <input type="text" class="form-control" id="localGuardianAdreessDristict" name="localGuardianAdreessDristict" value="{{$user1[0]->local_guardian_district}}" placeholder="Enter District"  <?php if( $user1[0]->resident_of == "Local") echo 'disabled' ?>>
 ...
 <script type="text/javascript">
        ...
        <div class="form-group col-md-6 col-sm-12">
          <label for="localAddressNearestRailwayStation">Nearest Railway Station<label style="color: red; font-size: 25px;vertical-align: sub;">*</label></label>
          <input type="text" class="form-control" id="localAddressNearestRailwayStation" name="localAddressNearestRailwayStation" value="{{$user1[0]->local_guardian_nearest_rail_station}}"  placeholder="Nearest Railway Station">
          <script type="text/javascript">
              document.getElementById("localAddressNearestRailwayStation").onkeypress=function(e)
                              { 
                              var e=window.event || e 
                              var keyunicode=e.charCode || e.keyCode 
                              return (keyunicode>=65 && keyunicode<=90 || keyunicode>=97 && keyunicode<=122 || keyunicode==8 || keyunicode==32)? true : false 
        ...
        <div class="form-group btnpadding col-md-6 col-sm-12">
          <a  href="{{ route('fe_guardian_details') }}">
