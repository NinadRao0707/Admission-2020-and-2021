 ...
 <!--         <div class="row-md-8">
   ...
   <div class="col-md-12">
      ...
      <div class="col-md-12">
        ...
        <p style="list-style-type:square; color:red;font-size:20px;"><b>Note : To participate in the Against CAP admission process, the candidate has to pay Rs 1000+Rs180 (GST).The payment link will be activated on 27th Jan(11:59 A.M) to 28th Jan (11:59 A.M) 2021 .</b></p>
      ...
      @foreach ($dtes as $dte)
              ...
              @endforeach
              <tr>
                    <td style=" " colspan="3" >  NOTE : THE PAYMENT LINK WILL BE ACTIVATED ON <strong>27<sup>th</sup> JAN </strong>(AFTER 11.59AM) TO <strong>28<sup>th</sup>JAN</strong> (TILL 11.59AM ) </td>
                    
                    <td style="text-transform: uppercase;background-color: #204a84" colspan="3" > <a href="mca_acap_form_payment"><button type="button" class="btn btn-success btn-view " style="width: 100%; text-transform: uppercase; border: 0px"  
                      <?php 
