...
<div class="container">
      ...
      <!-- <div class="row-md-8">
        <aside>
          <div class="list-group">
            ...
            <a href="{{ route('mca_document_upload') }}" class="list-group-item active">
  ...
  <div class="col-md-12">
    ...
    <h1>Document Upload&nbsp&nbsp&nbsp<label class="btn btn-sm btn-danger"  onclick="myFunction()" data-toggle="modal" data-target="#dteDocument" id="myBtn" style="font-weight: bold; border-radius: 100px">?</label></h1>
      <script>
function myFunction() {
  var a=document.getElementById("dteDocument");
   a.classList.add("fade");
            ...
            <div class="modal-body">
              ...
              <table class="table table-striped table-bordered" id="academic_modal">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>3</td>
                    <td>eSrutiny Centre Confirmation Reciept</td>
                  </tr>
                  <tr>
                    <td>4</td>
    ...
    <form method="post" action="{{ route('mca_document_upload') }}" enctype="multipart/form-data">
      {{ csrf_field() }}
      <div class="form-group col-md-12">
        <style type="text/css">
          ...
          <tbody>
            <div id="dteDocs">
              ...
              <tr>
                ...
                <td>
                  @if( $user1[0]->photo == 'Yes')
                  {{-- <a href="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->photo_path) }}" id="view_photo" target="_blank">View Document</a> --}}
                                        <!---------------------------View PDF Modal------------------------------->
                  ...
                  @else
                  <input type="file" style="display:block;overflow: hidden;" id="photo" name="photo" >
              ...
              <tr>
                ...
                <td>
                  @if( $user1[0]->signature == 'Yes')
                  {{-- <a href="{{ asset('uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->signature_path) }}" id="view_signature" target="_blank">View Document</a> --}}
                   <!---------------------------View PDF Modal------------------------------->
                   ...
                   <!-- Modal content-->
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <center>
                             <!--  <img src="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->signature_path) }}" width="500">changes done to reflect on local system follow the same for other docs -->
                  ...
                  @else
                  <input type="file" style="display: block;overflow: hidden;" id="signature" name="signature">
              ...
              <tr>
                ...
                <td>
                  ...
                  @else
                  <input type="file" style="display: block;overflow: hidden;" id="fc_confirmation_receipt" name="fc_confirmation_receipt">
                  @endif
                </td>
                <td>
                  @if( $user1[0]->fc_confirmation_receipt == 'Yes')
              ...
              <tr>
                <td>iv</td>
                <td>DTE Allotment Letter<font>*</font><p style="color: red"> (only .pdf) </p></td>
                ...
                <td>
                  ...
                  @else
                  <input type="file" style="display: block;overflow: hidden;" id="dte_allotment_letter" name="dte_allotment_letter">
              ...
              <tr style="display:none;">
                ...
                <td>
                  ...
                  @else
                  <input type="file" style="display: block;overflow: hidden;" id="arc_ackw_receipt" name="arc_ackw_receipt">
            ...
            <tr>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="cet_result" name="cet_result">
            ...
            <tr>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="ssc_marksheet" name="ssc_marksheet">
            ...
            <tr>
              <td>3</td>
              <td>HSC / Diploma Marksheet<font> *</font><p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="hsc_marksheet" name="hsc_marksheet">
            ...
            <tr>
              <td>4</td>
              <td>HSC Leaving/Transfer Certificate<font> *</font><p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="degree_leaving_tc" name="degree_leaving_tc">
            ...
            <tr>
              <td>5</td>
              <td>First Year Marksheet<font>*</font><p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="first_year_marksheet" name="first_year_marksheet">
            ...
            <tr>
              <td>6</td>
              <td>Second Year Marksheet<font> *</font><p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="second_year_marksheet" name="second_year_marksheet">
            ...
            <tr>
              <td>7</td>
              <td>Third Year Marksheet<font> *</font><p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="third_year_marksheet" name="third_year_marksheet">
            ...
            <tr>
              <td>9</td>
              <td>Convocation/Passing Certificate<font> *</font><p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="convocation_passing_certi" name="convocation_passing_certi">
            ...
            <tr>
                <td>8</td>
                <td>Migration Certificate<font>*</font><p style="color: red"> (only .pdf) </p></td>
                ...
                <td>
                  ...
                  @else
                  <input type="file" style="display: block;overflow: hidden;" id="migration_certi" name="migration_certi">
            ...
            <tr>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="birth_certi" name="birth_certi">
            ...
            <tr>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="domicile" name="domicile">
            ...
            <tr>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="proforma_o" name="proforma_o">
            ...
            <tr>
              <td>14</td>
              <td>Retention Certificate<p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="retention" name="retention">
            ...
            <tr>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="minority_affidavit" name="minority_affidavit">
            ...
            <tr>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="gap_certi" name="gap_certi">
            ...
            <tr>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="community_certi" name="community_certi">
            ...
            <tr>
              <td>18</td>
              <td>Caste Certificate<p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="caste_certi" name="caste_certi">
            ...
            <tr>
              <td>19</td>
              <td>Caste Validity Certificate<p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="caste_validity_certi" name="caste_validity_certi">
            ...
            <tr>
              <td>20</td>
              <td>Non-Creamy Layer Certificate<p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="non_creamy_layer_certi" name="non_creamy_layer_certi">
            ...
            <tr>
              <td>22</td>
              <td>Proforma A B1 B2<p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="proforma_a_b1_b2" name="proforma_a_b1_b2">
            ...
            <tr>
              <td>25</td>
              <td>Proforma V<p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                 ...
                 <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->proforma_v_path) }}" type="application/pdf" width="95%" height="700">
                            <embed src="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->proforma_v_path) }}" width="1200px" height="770px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="proforma_v" name="proforma_v">
           ...
           {{-- Proforma U --}}
            <tr>
              <td>25</td>
              <td>Proforma U<p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                 ...
                 <!---------------------------View PDF Modal------------------------------->
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <object data="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->proforma_u_path) }}" type="application/pdf" width="95%" height="700">
                            <embed src="{{ asset('/public/uploads/'.$user1[0]->dte_id.'_'.$hash.'/'.$user1[0]->proforma_u_path) }}" width="1200px" height="770px" />
                            </embed>
                            </object>
                            </div>
                            <div class="modal-footer">
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="proforma_u" name="proforma_u">
    ...
    {{-- Income Certificate --}}
            <tr>
              <td>24</td>
              <td>Income Certificate<p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="income_certi" name="income_certi">
            ...
            <tr>
              <td>25</td>
              <td>Proforma C D E<p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: none;overflow: hidden;" id="proforma_c_d_e" name="proforma_c_d_e">
            ...
            <tr>
              <td>27</td>
              <td>Physical Fitness Certificate<font> *</font><p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="medical_certi" name="medical_certi">
            ...
            <tr>
              <td>28</td>
              <td>Anti Ragging Certificate<font> *</font><p style="color: red"> (only .pdf) </p></td>
              ...
              <td>
                ...
                @else
                <input type="file" style="display: block;overflow: hidden;" id="anti_ragging_affidavit" name="anti_ragging_affidavit">
      ...
      <div class="form-group btnpadding col-sm-12  col-md-6">
        <a href="{{ route('mca_contact_details') }} ">
      ...
      <div class="form-group  btnpadding col-sm-12 col-md-6">
        ...
        @else
            <a href="{{ route('mca_admission_payment') }} ">
        @endif
