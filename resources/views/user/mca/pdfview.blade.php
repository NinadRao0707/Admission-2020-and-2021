...
<html>
   <head>
      <title>{{ "MCA_DTE_".$users1[0]->name_on_marksheet }}</title>
      <style>
         th {
         text-align: left;
         }
   ...
   <body>
      ...
      <div class="container" style="margin-left: 20px;margin-right: 20px; margin-top: 20px; ">
         <div class="col-md-12">
            <center>
                <img class="img-responsive" src="{{ asset('public/images/acap_header_mca_admissionForm.jpg') }}">
                <!--<label style="font-weight: bold;font-size:20px;">ADMISSION FORM</label>-->
            </center>
               ...
               <div class="col-md-12">
                  <table>
                     <thead>
                        ...
                        <tr>
                           <td id="hide">&nbsp;Unique Id/Aadhar No.</td>
                        ...
                        <tr>
                           <td id="hide">&nbsp;Permanent Address</td>
                           <td id="data" colspan="3">&nbsp;{{ $users1[0]->permanent_address_line1 }}</td>
                           <td id="data" colspan="3">&nbsp;{{ $users1[0]->permanent_address_line2 }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           <td id="hide" colspan="3">&nbsp;Nearest Railway Station</td>
                           <td id="data" colspan="3">&nbsp;{{ $users1[0]->permanent_nearest_rail_station }}</td>
                        </tr>
                        <tr>
                       ...
                       @if( $users1[0]->student_domicile_appl_no != 0 && $users1[0]->student_domicile_no != 0)
                        ...
                        <tr>
                           ...
                           <td id="data" colspan="2">&nbsp;{{ $users1[0]->cet_score }}</td>
                           <td id="hide" colspan="2">&nbsp;Month & Year of CET Exam</td>
                           <td id="data">&nbsp;{{ $users1[0]->cet_month }}, {{ $users1[0]->cet_year }}</td>
                        </tr>
                        <tr>
                           <td id="hide" colspan="2">&nbsp;MH-State General Merit No.</td>
                           <td id="data">&nbsp;{{ $users1[0]->mh_state_general_merit_no }}</td>
                           <td id="hide" colspan="2">&nbsp;Allotted in CAP Round</td>
                           <td id="data">&nbsp;{{ $users1[0]->allotted_cap_round }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           ...
                           <td id="data" colspan="2">&nbsp;{{ $users1[0]->course_allotted }} - {{ $users1['shift_allotted'] }}</td>
                        ...
                        <tr>
                           <td id="hide" colspan="2">&nbsp;University</td>
                           <td id="data" colspan="2">&nbsp;{{ $users1[0]->degree_university }}</td>
                           <td id="hide">&nbsp;University Type</td>
                           <td id="data">&nbsp;{{ $users1[0]->university_type }}</td>
                        </tr>
                        <tr>
                           <td id="hide" colspan="2">&nbsp;Name Of Institute</td>
                           <td id="data" colspan="4">&nbsp;{{ $users1[0]->degree_college_name }}</td>
                        </tr>
                        <tr>
                  ...
                  <table style="margin-top:5px;">
                     <thead>
                        ...
                        <tr>
                           <td id="line" colspan="12">
                              <p align="justify">
                                 ...
                                 Year of Post Graduate Course in Masters Of Computer Application for the Academic Year 2020-21. The information given by me in this application is true to the best of my knowledge & belief. If at later stage, it is found that I have furnished wrong information
                        ...
                        <tr>
                           <td id="data" colspan="12" rowspan="3" style="font-weight: bold;">&nbsp;&nbsp;&nbsp;<br><br>&nbsp;&nbsp;&nbsp;</td>
                        </tr>
                     </thead>
                  </table>
                  <!-------------------------------------------Page 2-------------------------------------------------->
                        ...
                        <tr>
                           <td id="line" colspan="6">
                              <p>I, Mr./Miss. <b>{{ $users1[0]->name_on_marksheet }}</b> have taken admission in this Institution in Masters of Computer Applications in the 
                                 <b>{{ $users1['shift_allotted'] }} Shift</b>, on my own, in consultation with my parents. I assure you that I will abide by all 
                  ...
                  <table>
                     <thead>
                        ...
                        <tr>
                           <td id="line" colspan="6">
                              <p>I Mr./Miss. <b>{{ $users1[0]->name_on_marksheet }}</b> hereby declare that I am taking admission to the Masters of Computer Applications for the Academic Year: <b>2020-21</b> in V.E.S Institute of Technology, Chembur-74.</p>
                              <p>I am not submitting the following Original Documents at the time of the above said Admission:</p>
                           </td>
                        </tr>
                        @if( $users1[0]->photo == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Profile Photo</td>
                        </tr>
                        @endif
                        @if( $users1[0]->signature == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Signature</td>
                        </tr>
                        @endif
                        @if( $users1[0]->fc_confirmation_receipt == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;eScutiny Centre Confirmation</td>
                        </tr>
                        @endif
                        @if( $users1[0]->dte_allotment_letter == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;DTE Allotment Letter</td>
                        </tr>
                        @endif
                        @if( $users1[0]->arc_ackw_receipt == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;ARC Acknowledgement</td>
                        </tr>
                        @endif
                        @if( $users1[0]->cet_result == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;CET Result</td>
                        </tr>
                        @endif
                        @if( $users1[0]->ssc_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;SSC Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->hsc_diploma_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;HSC / Diploma Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->degree_leaving_tc == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Degree Leaving/Transfer Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->first_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;First Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->second_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Second Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->third_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Third Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->convocation_passing_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Convocation/Passing Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->migration_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Migration Certificate</td>
                        </tr>
                        @endif
                        @if($users1[0]->domicile == 'Yes')
                            @if( $users1[0]->birth_certi == 'No')
                            <tr>
                               <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Birth Certificate</td>
                            </tr>
                            @endif
                        @endif
                        @if($users1[0]->birth_certi == 'Yes')
                            ...
                            <tr>
                               <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Domicile Certificate</td>
                            </tr>
                            @endif
                        @endif
                        @if( $users1[0]->proforma_o == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Proforma O</td>
                        </tr>
                        @endif
                        @if( $users1[0]->retention == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Retention Certificate</td>
                        </tr>
                        @endif
                        ...
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Gap Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->community_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Community Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Caste Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_validity_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Caste Validity Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->non_creamy_layer_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Non-Creamy Layer Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_a_b1_b2 == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Proforma A B1 B2</td>
                        </tr>
                        @endif
                        @if( $users1[0]->income_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Income Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_c_d_e == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Proforma C D E</td>
                        </tr>
                        @endif
                        @if( $users1[0]->medical_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Physical Fitness Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->anti_ragging_affidavit == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;Anti Ragging Certificate</td>
                        </tr>
                        @endif
                        <tr>
                           <td id="line" colspan="6">
                  ...
                  <table>
                     <thead>
                        ...
                        <tr>
                           <td id="line" colspan="6">
                              <p align="justify">
                                 I Mr./Miss. <b>{{ $users1[0]->name_on_marksheet }}</b> hereby declare that I am taking admission to the Masters of Computer Applications.
                                 for the Academic Year: 2020-21 in V.E.S Institute of Technology,
                                 Chembur-74.
                              </p>
                        ...
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;eScutiny Centre Confirmation</td>
                        </tr>
                        @endif
                        @if( $users1[0]->dte_allotment_letter == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;DTE Allotment Letter</td>
                        </tr>
                        @endif
                        @if( $users1[0]->arc_ackw_receipt == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;ARC Acknowledgement</td>
                        </tr>
                        @endif
                        @if( $users1[0]->cet_result == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;CET Result</td>
                        </tr>
                        @endif
                        @if( $users1[0]->ssc_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;SSC Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->hsc_diploma_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;HSC / Diploma Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->degree_leaving_tc == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Degree Leaving/Transfer Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->first_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;First Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->second_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Second Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->third_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Third Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->convocation_passing_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Convocation/Passing Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->migration_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Migration Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->birth_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Birth Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->domicile == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Domicile Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_o == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Proforma O</td>
                        </tr>
                        @endif
                        @if( $users1[0]->retention == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Retention Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->minority_affidavit == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Minority Affidavit</td>
                        </tr>
                        @endif
                        @if( $users1[0]->gap_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Gap Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->community_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Community Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Caste Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_validity_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Caste Validity Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->non_creamy_layer_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Non-Creamy Layer Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_a_b1_b2 == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Proforma A B1 B2</td>
                        </tr>
                        @endif
                        @if( $users1[0]->income_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Income Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_c_d_e == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Proforma C D E</td>
                        </tr>
                        @endif
                        @if( $users1[0]->medical_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Physical Fitness Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->anti_ragging_affidavit == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px; display:inline; " src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Anti Ragging Certificate</td>
                        </tr>
                        @endif
                        <tr>
                           <td id="line" colspan="6">
                        ...
                        <tr>
                           <td id="data" style="text-align: right;">Date&nbsp;&nbsp;&nbsp;</td>
                           <td id="data" colspan="3" style="font-weight: bold;">&nbsp;&nbsp;&nbsp;asd{{  $users1['date'] }}</td>
                           <td id="data" rowspan="2" colspan="4" style="text-align: center;">
                              <br><br><br><br>
                              <center>Candidate's Signature<br><b>({{ $users1[0]->name_on_marksheet }})</b></center>
                           </td>
                  ...
                  <table>
                     <thead>
                        <tr>
                           <th id="line" style="text-align: center; font-size: 25px;" colspan="6">RETENTION CERTIFICATES</th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           <td id="line" colspan="6">
                              <p align="justify">
                                 ...
                                 Academic Year: 2020-21 in the branch of Masters of Computer Applications <b>{{ $users1['shift_allotted'] }} Shift</b>.
                              </p>
                  ...
                  <table class="footerposition" cellspacing="10">
                   ...
                   <tr style= "height:200px;">
                      <td style="border-radius:15px;border:2px solid black;padding: 5px; width: 300px;">
                        <div style="width: 300px;">
                        <div style="border-radius:15px;margin-top:-90px;" height="1"><img style="width:300px;height:30px; border-radius:20px;" src="{{ asset('public/images/id.JPG') }}"></div>
                ...
                <div style="float:left;">
                    <p style="font-size:12px; margin-top:2px; margin-left:40px"><b><br>Provisional ID-Card</b></font></p>
                    <p style="font-size:10px;margin-left:40px"><b> ADMISSION YEAR 2020-2021</b></p>
                    <p style=" margin-top:-5px;"><b style="font-size:10px;">&nbsp;&nbsp;  NAME: {{ $users1['last_name'] }} {{ $users1['first_name'] }} {{$users1['middle_name']}}</b></p>
                    <p style=" margin-top:-5px;"><b style="font-size:10px;">&nbsp;&nbsp; D.O.B:</b>{{ $users1[0]->date_of_birth}}<b style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; B.Group:{{$users1[0]->blood_group}}</b></p>
                    <p style=" margin-top:-5px;"><b style="font-size:10px;">&nbsp;&nbsp;  LIB CARD NO:</b></p>
                    <p style=" margin-top:5px;"><b style="font-size:10px;">&nbsp;&nbsp;  Course:{{ $users1[0]->course_allotted }}</b></p>
                    <div style="margin-left:160px;"><img style="height:35px;margin-top:-30px;" max-width="100%" src="{{ asset('public/images/asmasign.jpg') }}"></div> 
                    <p style="margin-left:150px; margin-top:2px;"><b style="font-size:10px;">Admission In-charge</b></p>
                 </div>
                      </td>
                      <td style="float:right;text-align:left;width: 300px;border-radius:15px;border:2px solid black;padding: 5px;">
                         <div>
                        ...
                        <div class="style3">
                        <font size="2"><b style="text-align: center"><center>Validity of the card:MARCH-2021</center></b></font>
                        </div>
                        </div> 
                      </td>
                   </tr>
