                  ...
                  <table>
                     <thead>
                        ...
                        <tr>
                           ...
                           <td id="data" colspan="8">&nbsp;&nbsp;&nbsp;{{ $users1['email'] }}</td>
                        </tr>
                        <tr>
                           <td id="hide">&nbsp;&nbsp;&nbsp;Mobile No.</td>
                           <td id="data" colspan="8">&nbsp;&nbsp;&nbsp;{{ $users1['mobile'] }}</td>
                        </tr>
                        <tr>
