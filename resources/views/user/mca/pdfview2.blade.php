               ...
               <div class="col-md-12">
                        ...
                        <tr>
                           <td id="line" colspan="6">
                              <p align="justify">
                                 ...
                                 Year of Post Graduate  Courses in Master in Computer Application for the Academic Year 2020-21. The information given by me in this application is true to the best of my knowledge & belief. If at later stage, it is found that I have furnished wrong information
                  ...
                  <table>
                     <thead>
                        ...
                        <tr>
                           <td id="line" colspan="6">
                              <p>I Mr./Miss. <b>{{ $users1[0]->name_on_marksheet }}</b> hereby declare that I am taking admission to the Masters of Computer Applications Course <b>{{ $users1['shift_allotted'] }}</b> branch for the Academic Year: <span><b>2020-21</b></span> in V.E.S Institute of Technology, Chembur-74.</p>
                              <p>I am not submitting the following Original Documents at the time of the above said Admission:</p>
                           </td>
                        </tr>
                        @if( $users1[0]->photo == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Profile Photo</td>
                        </tr>
                        @endif
                        @if( $users1[0]->signature == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Signature</td>
                        </tr>
                        @endif
                        @if( $users1[0]->fc_confirmation_receipt == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;eScutiny Centre Confirmation</td>
                        </tr>
                        @endif
                        @if( $users1[0]->dte_allotment_letter == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;DTE Allotment Letter</td>
                        </tr>
                        @endif
                        @if( $users1[0]->arc_ackw_receipt == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;ARC Acknowledgement</td>
                        </tr>
                        @endif
                        @if( $users1[0]->cet_result == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;CET Result</td>
                        </tr>
                        @endif
                        @if( $users1[0]->ssc_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;SSC Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->hsc_diploma_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;HSC / Diploma Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->degree_leaving_tc == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Degree Leaving/Transfer Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->first_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;First Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->second_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Second Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->third_year_marksheet == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Third Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->convocation_passing_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Convocation/Passing Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->migration_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Migration Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->birth_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Birth Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->domicile == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Domicile Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_o == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Proforma O</td>
                        </tr>
                        @endif
                        @if( $users1[0]->retention == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Retention Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->minority_affidavit == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Minority Affidavit</td>
                        </tr>
                        @endif
                        @if( $users1[0]->gap_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Gap Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->community_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Community Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Caste Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_validity_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Caste Validity Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->non_creamy_layer_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Non-Creamy Layer Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_a_b1_b2 == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Proforma A B1 B2</td>
                        </tr>
                        @endif
                        @if( $users1[0]->income_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Income Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_c_d_e == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Proforma C D E</td>
                        </tr>
                        @endif
                        @if( $users1[0]->medical_certi == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Physical Fitness Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->anti_ragging_affidavit == 'No')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-remove.png') }}">&nbsp;&nbsp;&nbsp;Anti Ragging Certificate</td>
                        </tr>
                        @endif
                        <tr>
                           <td id="line" colspan="6">
                  ...
                  <table>
                     <thead>
                        ...
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;eScutiny Centre Confirmation</td>
                        </tr>
                        @endif
                        @if( $users1[0]->dte_allotment_letter == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;DTE Allotment Letter</td>
                        </tr>
                        @endif
                        @if( $users1[0]->arc_ackw_receipt == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;ARC Acknowledgement</td>
                        </tr>
                        @endif
                        @if( $users1[0]->cet_result == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;CET Result</td>
                        </tr>
                        @endif
                        @if( $users1[0]->ssc_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;SSC Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->hsc_diploma_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;HSC / Diploma Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->degree_leaving_tc == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Degree Leaving/Transfer Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->first_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;First Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->second_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Second Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->third_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Third Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->convocation_passing_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Convocation/Passing Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->migration_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Migration Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->birth_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Birth Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->domicile == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Domicile Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_o == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Proforma O</td>
                        </tr>
                        @endif
                        @if( $users1[0]->retention == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Retention Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->minority_affidavit == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Minority Affidavit</td>
                        </tr>
                        @endif
                        @if( $users1[0]->gap_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Gap Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->community_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Community Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Caste Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_validity_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Caste Validity Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->non_creamy_layer_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Non-Creamy Layer Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_a_b1_b2 == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Proforma A B1 B2</td>
                        </tr>
                        @endif
                     
                        @if( $users1[0]->income_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Income Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_c_d_e == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Proforma C D E</td>
                        </tr>
                        @endif
                        @if( $users1[0]->medical_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Physical Fitness Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->anti_ragging_affidavit == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;&nbsp;&nbsp;Anti Ragging Certificate</td>
                        </tr>
                        @endif
                        <tr>
                           <td id="line" colspan="6">
                  ...
                  <table>
                     <thead>
                        ...
                        <tr>
                           <td id="line" colspan="6">
                              <p align="justify">
                                 ...
                                 Academic Year: 2020-21 in the Course of Masters in Computer Application, {{$users1['shift_allotted']}}
                              </p>
                        ...
                        @if( $users1[0]->fc_confirmation_receipt == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;eScutiny Centre Confirmation</td>
                        </tr>
                        @endif
                        @if( $users1[0]->dte_allotment_letter == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;DTE Allotment Letter</td>
                        </tr>
                        @endif
                        @if( $users1[0]->arc_ackw_receipt == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;ARC Acknowledgement</td>
                        </tr>
                        @endif
                        @if( $users1[0]->cet_result == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;CET Result</td>
                        </tr>
                        @endif
                        @if( $users1[0]->ssc_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;SSC Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->hsc_diploma_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;HSC / Diploma Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->degree_leaving_tc == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Degree Leaving/Transfer Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->first_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;First Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->second_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Second Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->third_year_marksheet == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Third Year Marksheet</td>
                        </tr>
                        @endif
                        @if( $users1[0]->convocation_passing_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Convocation/Passing Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->migration_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Migration Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->birth_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Birth Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->domicile == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Domicile Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_o == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Proforma O</td>
                        </tr>
                        @endif
                        @if( $users1[0]->retention == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Retention Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->minority_affidavit == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Minority Affidavit</td>
                        </tr>
                        @endif
                        @if( $users1[0]->gap_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Gap Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->community_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Community Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Caste Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->caste_validity_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Caste Validity Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->non_creamy_layer_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Non-Creamy Layer Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_a_b1_b2 == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Proforma A B1 B2</td>
                        </tr>
                        @endif
                        @if( $users1[0]->income_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Income Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->proforma_c_d_e == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Proforma C D E</td>
                        </tr>
                        @endif
                        @if( $users1[0]->medical_certi == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive"style="height:10px;" src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Physical Fitness Certificate</td>
                        </tr>
                        @endif
                        @if( $users1[0]->anti_ragging_affidavit == 'Yes')
                        <tr>
                           <td id="line" colspan="6" style="font-weight: bold;font-size:12px;"><img class="img-responsive" style="height:10px;"src="{{ asset('public/images/glyphicon-ok.jpg') }}">&nbsp;Anti Ragging Certificate</td>
                        </tr>
                        @endif
                        <tr>
                           <td id="line" colspan="6">
                ...
                <div style="float:left;">
                    ...
                    <div style="margin-left:210px;"><img style="height:35px;margin-top:-30px;" max-width="100%" src="{{ asset('public/images/asmasign.jpg') }}"></div>
