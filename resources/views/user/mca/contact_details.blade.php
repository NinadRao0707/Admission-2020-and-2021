...
<style type="text/css">
  @media  (max-width: 1169px) and (min-width: 1022px){
.navincrease{
      ...
      <!-- <div class="row-md-8">
        <aside>
          <div class="list-group">
            ...
            <a href="{{ route('mca_contact_details') }}" class="list-group-item active">
...
function myFunction() {
  var a=document.getElementById("dteContact");
   a.classList.add("fade");
      ...
      @endif
      <!---------------------------------Modal Close------------------------------------------>
      <form method="post" action="{{ route('mca_contact_details') }}">
        {{ csrf_field() }}
...
<script type="text/javascript">
        ...
        <div class="form-group btnpadding col-md-6 col-sm-12">
          <a  href="{{ route('mca_guardian_details') }}">
