      ...
      <!-- <div class="row-md-8">
        <aside>
          <div class="list-group">
            ...
            <a href="{{ route('mca_personal_details') }}" class="list-group-item active">
...
function myFunction() {
  var a=document.getElementById("dtePersonal");
   a.classList.add("fade");
    ...
    @endif
    <!---------------------------------Modal Close------------------------------------------>
    <form method="post" action="{{ route('mca_personal_details') }}">
      {{ csrf_field() }}
      ...
      <div class="form-group col-md-4 col-sm-12">
        ...
        <input type="text" class="form-control" id="casteTribe" name="casteTribe" value = "{{$user1[0]->caste_tribe}}" placeholder="Caste/tribe" maxlength="15" required>
      ...
      <div class="form-group col-md-6 col-sm-12">
        <a  href="{{ route('mca_academic_details') }}">
