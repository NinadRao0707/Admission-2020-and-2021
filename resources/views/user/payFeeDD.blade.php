...
<nav class="navbar navincrease navbar-expand-md navbar-light fixed-top" id="menu1" style="background-color: #f7fbfc" >
 ...
 <div class=" col-md-3 logo" style="padding-left: 50px "><a href="{{ asset('admission') }}"><img src="{{ asset('public/images/logo.png') }}" class="img-responsive main_nav_logo" style="float:left;margin-left:-45px;width:250px;height:75px ;padding-bottom:10px" /></a>
...
<div class="container">
  <br>
   ...
   <div class="col-md-12">
       <center>
       <img src="{{ asset('public/images/banking-awareness-demand-draft.jpg') }}" class="img-responsive" id="dd_demo" name="dd_demo">
        </center>
   </div>
   <div class="col-md-12">
