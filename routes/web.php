...
//  Route::post('/dexpertsystems.com/Router/responseEazyPay','HomeController@returnStatus');
...
// Route::get('/getotp','HomeController@sendotp');
...
Route::post('fe_acap_form_payment','HomeController@payFee');
...
//common fees transfer
Route::get('feestransfer','AdminController@feestransfer')->name('feestransfer');
Route::post('feestransfer','AdminController@postfeestransfer');
