...
class HomeController extends Controller
{
  ...
  public static function returnStatus(Request $request)
  {
    ...
    if (!empty($_POST)) {
      ...
      if ($_POST['Response_Code'] == "E001") {
        $status = "Unauthorized Payment Mode";
      }
      if ($_POST['Response_Code'] == "E002") {
        $status = "Unauthorized Key";
      }
      if ($_POST['Response_Code'] == "E003") {
        $status = "Unauthorized Packet";
      }
      if ($_POST['Response_Code'] == "E004") {
        $status = "Unauthorized Merchant";
      }
      if ($_POST['Response_Code'] == "E005") {
        $status = "Unauthorized Return URL";
      }
      if ($_POST['Response_Code'] == "E006") {
        $status = "Transaction Already Paid";
      }
      if ($_POST['Response_Code'] == "E007") {
        $status = "Transaction Failed";
      }
      if ($_POST['Response_Code'] == "E008") {
        $status = "Failure from Third Party due to Technical Error or Funds Shortage";
      }
      if ($_POST['Response_Code'] == "E0031") {
        $status = "Mandatory fields coming from merchant are empty";
      }
      if ($_POST['Response_Code'] == "E0032") {
        $status = "Mandatory fields coming from database are empty";
      }
      if ($_POST['Response_Code'] == "E0033") {
        $status = "Payment mode coming from merchant is empty";
      }
      if ($_POST['Response_Code'] == "E0034") {
        $status = "PG Reference number coming from merchant is empty";
      }
      if ($_POST['Response_Code'] == "E0035") {
        $status = "Sub merchant id coming from merchant is empty";
      }
      if ($_POST['Response_Code'] == "E0036") {
        $status = "Transaction amount coming from merchant is empty";
      }
      if ($_POST['Response_Code'] == "E0037") {
        $status = "Payment mode coming from merchant is other than 0 to 9";
      }
      if ($_POST['Response_Code'] == "E0038") {
        $status = "Transaction amount coming from merchant is more than 9 digit length";
      }
      if ($_POST['Response_Code'] == "E0039") {
        $status = "Mandatory value Email in wrong format";
      }
      if ($_POST['Response_Code'] == "E00310") {
        $status = "Mandatory value mobile number in wrong format";
      }
      if ($_POST['Response_Code'] == "E00311") {
        $status = "Mandatory value amount in wrong format";
      }
      if ($_POST['Response_Code'] == "E00312") {
        $status = "Mandatory value Pan card in wrong format";
      }
      if ($_POST['Response_Code'] == "E00313") {
        $status = "Mandatory value Date in wrong format";
      }
      if ($_POST['Response_Code'] == "E00314") {
        $status = "Mandatory value String in wrong format";
      }
      if ($_POST['Response_Code'] == "E00315") {
        $status = "Optional value Email in wrong format";
      }
      if ($_POST['Response_Code'] == "E00316") {
        $status = "Optional value mobile number in wrong format";
      }
      if ($_POST['Response_Code'] == "E00317") {
        $status = "Optional value amount in wrong format";
      }
      if ($_POST['Response_Code'] == "E00318") {
        $status = "Optional value pan card number in wrong format";
      }
      if ($_POST['Response_Code'] == "E00319") {
        $status = "Optional value date in wrong format";
      }
      if ($_POST['Response_Code'] == "E00320") {
        $status = "Optional value string in wrong format";
      }
      if ($_POST['Response_Code'] == "E00321") {
        $status = "Request packet mandatory columns is not equal to mandatory columns set in enrolment or optional columns are not equal to optional columns length set in enrolment";
      }
      if ($_POST['Response_Code'] == "E00324") {
        $status = "Merchant Reference Number and Mandatory Columns are Null";
      }
      if ($_POST['Response_Code'] == "E00325") {
        $status = "Merchant Reference Number Duplicate";
      }
      if ($_POST['Response_Code'] == "E00326") {
        $status = "Sub merchant id coming from merchant is non numeric";
      }
      if ($_POST['Response_Code'] == "E00327") {
        $status = "Cash Challan Generated";
      }
      if ($_POST['Response_Code'] == "E00328") {
        $status = "Cheque Challan Generated";
      }
      if ($_POST['Response_Code'] == "E00329") {
        $status = "NEFT Challan Generated";
      }
      if ($_POST['Response_Code'] == "E00330") {
        $status = "Transaction Amount and Mandatory Transaction Amount mismatch in Request URL";
      }
      ...
      if (isset($_POST['Unique_Ref_Number'])) {
        if ($_POST['Unique_Ref_Number'] != null || $_POST['Unique_Ref_Number'] != '') {
          $transID = $_POST['Unique_Ref_Number'];
        }
      }
      if (isset($_POST['Service_Tax_Amount'])) {
        if ($_POST['Service_Tax_Amount'] != null || $_POST['Service_Tax_Amount'] != '') {
          $sTaxAmt = $_POST['Service_Tax_Amount'];
        }
      }
      if (isset($_POST['Processing_Fee_Amount'])) {
        if ($_POST['Processing_Fee_Amount'] != null || $_POST['Processing_Fee_Amount'] != '') {
          $pFeeAmt = $_POST['Processing_Fee_Amount'];
        }
      }
      if (isset($_POST['Total_Amount'])) {
        if ($_POST['Total_Amount'] != null || $_POST['Total_Amount'] != '') {
          $totalAmt = $_POST['Total_Amount'];
        }
      }
      if (isset($_POST['Transaction_Amount'])) {
        if ($_POST['Transaction_Amount'] != null || $_POST['Transaction_Amount'] != '') {
          $transAmt = $_POST['Transaction_Amount'];
        }
      }
      if (isset($_POST['Transaction_Date'])) {
        if ($_POST['Transaction_Date'] != null || $_POST['Transaction_Date'] != '') {
          $transTimestamp = $_POST['Transaction_Date'];
        }
      }
      if (isset($_POST['Payment_Mode'])) {
        if ($_POST['Payment_Mode'] != null || $_POST['Payment_Mode'] != '') {
          $paymentMode = $_POST['Payment_Mode'];
        }
      }
      if (isset($_POST['ReferenceNo'])) {
        if ($_POST['ReferenceNo'] != null || $_POST['ReferenceNo'] != '') {
  ...
  public function sendPassswordEmail(Request $request)
  {
    ...
    if(!$sl){
      $mymessage = "User with the entered DTE Id not found!";
      return redirect()->back()->withErrors($mymessage);
    }
    ...
    if (DB::table('student_login')->where('email', $email)->exists()) {
      ...
      $mymessage = "User with the entered Email not found!";
      return redirect()->back()->withErrors($mymessage);
    }
  }
...
*/
  ...
  public static function uploadfeDocumentUpload(Request $request)
  {
    ...
    $test_parent_signature = $request->input('parent_signature');
    
    //  return $test_signature;
    //return $a;
    if ($fe_students->parent_signature_path == null) {
      if ($test_parent_signature == "yes") {
        if ($request->hasFile('parent_signature')) {
          $rules = ['parent_signature' => 'mimes:jpg,png,jpeg'];
          $validator = Validator::make(Input::all(), $rules);
          if ($validator->fails()) {
            $request->session()->flash('parent_signature_error', 'Please Upload Only JPG or PNG type image. File size should be less than 1 mb.');
            return redirect()->route('fe_document_upload');
          }
          //for name of parents signature
          $parent_signature_name = $request->input('parent_signature_name');
          $extension = $request->file('parent_signature')->getClientOriginalExtension();
          $filenametostore = 'parent_signature' . $dte_id . '.' . $extension;
          $path = $request->file('parent_signature')->storeAs($destinationPath, $filenametostore, 'public_uploads');
          $fe_students->parent_signature_path = $filenametostore;
          $fe_students->parent_signature_name = $parent_signature_name;
          $fe_students->parent_signature = 'Yes';
          $fe_students->save();
        } else {
          $fe_students->parent_signature = 'No';
          $fe_students->save();
        }
      } elseif ($test_parent_signature == "no") {
        $fe_students->parent_signature = 'No';
      } elseif ($test_parent_signature == null) {
        $request->session()->flash('parent_signature_error', 'Please select an option');
        return redirect()->route('fe_document_upload');
      }
    }
  ...
  public static function uploadfeAcapDocumentUpload(Request $request)
  {
      ...
      if ($test_ssc_marksheet == "yes") {
        if ($request->hasFile('ssc_marksheet')) {
          ...
          if ($validator->fails()) {
            $request->session()->flash('ssc_marksheet_error', 'Please Upload Only PDF. File size should be less than 1 mb.');
            //return "Hello";
            return redirect()->route('fe_acap_document_upload');
          }
    ...
    $user1 = DB::table('fe_students')->select('dte_id', 'is_cet', 'is_jee', 'photo', 'photo_path', 'signature', 'signature_path', 'parent_signature', 'parent_signature_path', 'parent_signature_name','fc_confirmation_receipt', 'fc_confirmation_receipt_path', 'cet_result', 'cet_result_path', 'jee_result', 'jee_result_path', 'ssc_marksheet', 'ssc_marksheet_path', 'hsc_marksheet', 'hsc_marksheet_path', 'hsc_passing_certi', 'hsc_passing_certi_path', 'birth_certi', 'birth_certi_path', 'domicile', 'domicile_path', 'proforma_o', 'proforma_o_path', 'minority_affidavit', 'minority_affidavit_path', 'community_certi', 'community_certi_path', 'medical_certi', 'medical_certi_path', 'anti_ragging_affidavit', 'anti_ragging_affidavit_path', 'gap_certi', 'gap_certi_path', 'is_document_completed')->where('dte_id', $dte_id)->get();
    $hash = DB::table('student_login')->select('hash')->where('dte_id', $dte_id)->get();
    $hash = $hash[0]->hash;
    ...
    if ($dte_id != null) {
      ...
      if ($dte_login[0]->dte_login == 1 || $acap_login[0]->acap_login == 1) {
        ...
        if (DB::table('fe_students')->where('dte_id', $dte_id)->exists()) {
          ...
          $usercategory = DB::table('fe_students')->select('category')->where('dte_id', $dte_id)->get();
          $partpaycheck = DB::table('part_payment')->select('dte_id')->where('dte_id', $dte_id)->get();
          if($partpaycheck === null){
            $partpaycheck = 'false';
          }
          else{
            $partpaycheck = 'true';
          ...
          return view('user.fe.final_submit')->with('check', $check)->with('payment', $payment)->with('user1', $user1)->with('usercategory', $usercategory)->with('partpaycheck',$partpaycheck);
        } else {
  ...
  public static function uploaddseDocumentUpload(Request $request)
  {
    ...
    //  return $test_signature;
    //return $a;
    if ($dse_students->parent_signature_path == null) {
      if ($test_parent_signature == "yes") {
        if ($request->hasFile('parent_signature')) {
          $rules = ['parent_signature' => 'mimes:jpg,png,jpeg'];
          $validator = Validator::make(Input::all(), $rules);
          ...
          $filenametostore = 'parent_signature' . $dte_id . '.' . $extension;
          $path = $request->file('parent_signature')->storeAs($destinationPath, $filenametostore, 'public_uploads');
          $dse_students->parent_signature_path = $filenametostore;
          $dse_students->parent_signature_name = $parent_signature_name;
          $dse_students->parent_signature = 'Yes';
          $dse_students->save();
        } else {
          $dse_students->parent_signature = 'No';
          $dse_students->save();
        }
      } elseif ($test_parent_signature == "no") {
        $dse_students->parent_signature = 'No';
    ...
    if ($dte_id != null) {
      ...
      if ($dte_login[0]->dte_login == 1 || $acap_login[0]->acap_login == 1) {
        if (DB::table('dse_students')->where('dte_id', $dte_id)->exists()) {
          ...
          return view('user.dse.final_submit')->with('check', $check)->with('payment', $payment)->with('user1', $user1)->with('user1', $user1)->with('usercategory',$usercategory)->with('partpaycheck',$partpaycheck);
        } else {
          $array_object1 = [['is_personal_completed' => null, 'is_guardian_completed' => null, 'is_contact_completed' => null, 'is_dte_details_completed' => null, 'is_document_completed' => null, 'is_academic_completed' => null, 'is_payment_completed' => null]];
          $check = json_decode(json_encode($array_object1));
          $array_object2 = [['balance_amt' => null]];
          ...
          return view('user.dse.final_submit')->with('check', $check)->with('payment', $payment)->with('usercategory',$usercategory)->with('partpaycheck',$partpaycheck);
        }
      } else
        return redirect()->route('dse_profile');
    } else
  ...
  public static function uploadmcaDocumentUpload(Request $request)
  {
    ...
    if ($mca_students->parent_signature_path == null) {
      if ($test_parent_signature == "yes") {
        if ($request->hasFile('parent_signature')) {
          $rules = ['parent_signature' => 'mimes:jpg,png,jpeg'];
          $validator = Validator::make(Input::all(), $rules);
          ...
          $filenametostore = 'parent_signature' . $dte_id . '.' . $extension;
          $path = $request->file('parent_signature')->storeAs($destinationPath, $filenametostore, 'public_uploads');
          $mca_students->parent_signature_path = $filenametostore;
          $mca_students->parent_signature_name = $parent_signature_name;
          $mca_students->parent_signature = 'Yes';
          $mca_students->save();
        } else {
          $mca_students->parent_signature = 'No';
          $mca_students->save();
        }
      } elseif ($test_parent_signature == "no") {
        $mca_students->parent_signature = 'No';
...
*/
  ...
  public static function  showmeAcapDocumentUpload(Request $request)
  {
    ...
    if ($dte_login[0]->dte_login == 1 || $acap_login[0]->acap_login == 1) {
      if (DB::table('me_students')->where('dte_id', $dte_id)->exists()) {
        $user = DB::table('student_login')->select('hash')->where('dte_id', $dte_id)->get();
        $user1 = DB::table('me_students')->select('dte_id', 'fc_confirmation_receipt', 'parent_signature', 'parent_signature_path', 'parent_signature_name','fc_confirmation_receipt_path', 'dte_allotment_letter', 'dte_allotment_letter_path', 'arc_ackw_receipt', 'arc_ackw_receipt_path', 'gate_result', 'gate_result_path', 'ssc_marksheet', 'ssc_marksheet_path', 'hsc_marksheet', 'hsc_marksheet_path', 'degree_leaving_tc', 'degree_leaving_tc_path', 'first_year_marksheet', 'first_year_marksheet_path', 'second_year_marksheet', 'second_year_marksheet_path', 'third_year_marksheet', 'third_year_marksheet_path', 'fourth_year_marksheet', 'fourth_year_marksheet_path', 'convocation_passing_certi', 'convocation_passing_certi_path', 'migration_certi', 'migration_certi_path', 'birth_certi', 'birth_certi_path', 'domicile', 'domicile_path', 'proforma_o', 'proforma_o_path', 'retention', 'retention_path', 'minority_affidavit', 'minority_affidavit_path', 'gap_certi', 'gap_certi_path', 'community_certi', 'community_certi_path', 'caste_certi', 'caste_certi_path', 'caste_validity_certi', 'caste_validity_certi_path', 'non_creamy_layer_certi', 'non_creamy_layer_certi_path', 'proforma_h', 'proforma_h_path', 'proforma_a_b1_b2', 'proforma_a_b1_b2_path', 'proforma_f_f1', 'proforma_f_f1_path', 'income_certi', 'income_certi_path', 'proforma_c_d_e', 'proforma_c_d_e_path', 'anti_ragging_affidavit', 'anti_ragging_affidavit_path', 'proforma_j_k_l', 'proforma_j_k_l_path', 'medical_certi', 'medical_certi_path', 'photo', 'photo_path', 'signature', 'signature_path')->where('dte_id', $dte_id)->get();
        //return $user1;
      } else {
        $user = DB::table('student_login')->select('hash')->where('dte_id', $dte_id)->get();
        $array_object = [['dte_id' => $dte_id, 'fc_confirmation_receipt' => null, 'fc_confirmation_receipt_path' => null, 'dte_allotment_letter' => null, 'dte_allotment_letter_path' => null, 'arc_ackw_receipt' => null, 'arc_ackw_receipt_path' => null, 'gate_result' => null, 'gate_result_path' => null, 'ssc_marksheet' => null, 'ssc_marksheet_path' => null, 'hsc_marksheet' => null, 'hsc_marksheet_path' => null, 'degree_leaving_tc' => null, 'degree_leaving_tc_path' => null, 'first_year_marksheet' => null, 'first_year_marksheet_path' => null, 'second_year_marksheet' => null, 'second_year_marksheet_path' => null, 'third_year_marksheet' => null, 'third_year_marksheet_path' => null, 'fourth_year_marksheet' => null, 'fourth_year_marksheet_path' => null, 'convocation_passing_certi' => null, 'convocation_passing_certi_path' => null, 'migration_certi' => null, 'migration_certi_path' => null, 'birth_certi' => null, 'birth_certi_path' => null, 'domicile' => null, 'domicile_path' => null, 'proforma_o' => null, 'proforma_o_path' => null, 'retention' => null, 'retention_path' => null, 'minority_affidavit' => null, 'minority_affidavit_path' => null, 'gap_certi' => null, 'gap_certi_path' => null, 'community_certi' => null, 'community_certi_path' => null, 'caste_certi' => null, 'caste_certi_path' => null, 'caste_validity_certi' => null, 'caste_validity_certi_path' => null, 'non_creamy_layer_certi' => null, 'non_creamy_layer_certi_path' => null, 'proforma_h' => null, 'proforma_h_path' => null, 'proforma_a_b1_b2' => null, 'proforma_a_b1_b2_path' => null, 'proforma_f_f1' => null, 'proforma_f_f1_path' => null, 'income_certi' => null, 'income_certi_path' => null, 'proforma_c_d_e' => null, 'proforma_c_d_e_path' => null, 'anti_ragging_affidavit' => null, 'anti_ragging_affidavit_path' => null, 'proforma_j_k_l' => null, 'proforma_j_k_l_path' => null, 'medical_certi' => null, 'medical_certi_path', 'photo' => null, 'photo_path' => null, 'signature' => null, 'signature_path' => null]];
  ...
  public static function uploadmeDocumentUpload(Request $request)
  {
    ...
    if ($me_students->parent_signature_path == null) {
      if ($test_parent_signature == "yes") {
        if ($request->hasFile('parent_signature')) {
          $rules = ['parent_signature' => 'mimes:jpg,png,jpeg'];
          $validator = Validator::make(Input::all(), $rules);
          ...
          $filenametostore = 'parent_signature' . $dte_id . '.' . $extension;
          $path = $request->file('parent_signature')->storeAs($destinationPath, $filenametostore, 'public_uploads');
          $me_students->parent_signature_path = $filenametostore;
          $me_students->parent_signature_name = $parent_signature_name;
          $me_students->parent_signature = 'Yes';
          $me_students->save();
        } else {
          $me_students->parent_signature = 'No';
          $me_students->save();
        }
      } elseif ($test_parent_signature == "no") {
        $me_students->parent_signature = 'No';
    ...
    if ($dte_id != null) {
      ...
      if ($dte_login[0]->dte_login == 1 || $acap_login[0]->acap_login == 1) {
        if (DB::table('me_students')->where('dte_id', $dte_id)->exists()) {
          ...
          return view('user.me.final_submit')->with('check', $check)->with('payment', $payment)->with('user1', $user1)->with('usercategory',$usercategory)->with('partpaycheck',$partpaycheck);
        } else {
          // return'hello';
    ...
    if ($dte_id != null) {
      ...
      if ($dte_login[0]->dte_login == 1 || $acap_login[0]->acap_login == 1) {
        if (DB::table('mca_students')->where('dte_id', $dte_id)->exists()) {
          ...
          return view('user.mca.final_submit')->with('check', $check)->with('payment', $payment)->with('user1', $user1)->with('usercategory',$usercategory)->with('partpaycheck',$partpaycheck);
        } else {
          $array_object1 = [['is_personal_completed' => null, 'is_guardian_completed' => null, 'is_contact_completed' => null, 'is_dte_details_completed' => null, 'is_document_completed' => null, 'is_academic_completed' => null, 'is_payment_completed' => null]];
          $check = json_decode(json_encode($array_object1));
          $array_object2 = [['balance_amt' => null]];
          ...
          return view('user.mca.final_submit')->with('check', $check)->with('payment', $payment)->with('usercategory',$usercategory)->with('partpaycheck',$partpaycheck);
        }
      } else
        return redirect()->route('mca_profile');
    } else
