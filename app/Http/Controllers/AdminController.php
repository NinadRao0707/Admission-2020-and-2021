...
$name=$stud[0]->first_name ." ".$stud[0]->middle_name." ".$stud[0]->last_name;
    ...
    // return $pgname; 
    if($pgname=='admissionForms/pg/index.php/adminDocumentVerifierAcap'){
    ...
    DB::select("call delete_form_verified('$dte_id')");
     ...
     return redirect('adminSeizer');
      ...
      if(strpos($pgname, 'admissionForms/pg/index.php/adminFormView') !== false){
        // return 'done';
     // DB::select("call delete_document_verified('$dte_id')");
    // DB::select("call delete_form_verified('$dte_id')");
    ...
    if($pgname=='admissionForms/pg/index.php/adminSearchDocumentVerifier'){
      Mail::send('user.adminmail', $data, function ($message) use($email)
      {
      $message->to($email, '')->subject('Reupload Documents');
      $message->from('vesit.admission@ves.ac.in', 'Vesit Admissions');
...
// ;
         ...
         public static function post_dd(Request $request)
         {
            ...
            //  return $dte_id;
             ...
             $user = DB::select(DB::raw("SELECT * from admission where dte_id LIKE '%".$dte_id."%' AND admission_type = 'ACAP' order by updated_at desc limit 1"));
             if($course == 'FEG') {
...
public static function deleteAdmin($id, Request $request)
    ...
    public function postAdminsEvent(Request $request)
    {
       ...
       $request->session()->put('admissType',$event);
...
public function pdfviewdse4cmpnshift1(Request $request)
    ...
    if ($role != 'null' && ($role=='Admin' || $role=='Super Admin') )
    {
        if($course == "MEG")
        {
         $users1 = DB::select(DB::raw("select * from admission where admission_type = 'ACAP' and course='MEG' and status = 'ADMITTED' and updated_at in (select max(updated_at) from admission group by dte_id) and branch = 'INFT';"));

        $users2= DB::select(DB::raw("select * from admission where admission_type = 'ACAP' and course='MEG' and status = 'ADMITTED' and updated_at in (select max(updated_at) from admission group by dte_id) and branch = 'ETRX';"));

        $users3 = DB::select(DB::raw("select * from admission where admission_type = 'ACAP' and course='MEG' and status = 'ADMITTED' and updated_at in (select max(updated_at) from admission group by dte_id) and branch = 'INST';"));

        
        $users4 = DB::select(DB::raw("select * from admission where admission_type = 'DTE' and course='MEG' AND status = 'ADMITTED' and updated_at in (select max(updated_at) from admission group by dte_id) and branch = 'INFT'"));

        $users5 = DB::select(DB::raw("select * from admission where admission_type = 'DTE' and course='MEG' AND status = 'ADMITTED' and updated_at in (select max(updated_at) from admission group by dte_id) and branch = 'EXTC'"));

        $users6 = DB::select(DB::raw("select * from admission where admission_type = 'DTE' and course='MEG' AND status = 'ADMITTED' and updated_at in (select max(updated_at) from admission group by dte_id) and branch = 'INST'"));
       ...
       // return $u; 
        ...
        {
                $user1 = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN SINDHI MINORITY' OR fees_category = 'SINDHI(EBC)' OR fees_category = 'SINDHI'    )  and status = 'ADMITTED' and shift_allotted = 'Morning' and admission_type = 'DTE'"));
                $user2 = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN SINDHI MINORITY'  OR fees_category = 'SINDHI(EBC)' OR fees_category = 'SINDHI' )  and status = 'CANCELLED' and shift_allotted = 'Morning' and admission_type = 'DTE'"));
                $user3 = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =   'SINDHI' OR fees_category = 'SINDHI(EBC)' OR fees_category = 'SINDHI' )  and status = 'ADMITTED' and shift_allotted = 'Morning' and admission_type = 'ACAP'"));
                $user4 = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =  'SINDHI' OR fees_category = 'SINDHI(EBC)' OR fees_category = 'SINDHI' )  and status = 'CANCELLED' and shift_allotted = 'Morning' and admission_type = 'ACAP'"));
               
                $user5 = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN SINDHI MINORITY' OR fees_category = 'SINDHI(EBC)' OR fees_category = 'SINDHI'  )  and status = 'ADMITTED' and shift_allotted = 'Afternoon' and admission_type = 'DTE'"));
                $user6 = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN SINDHI MINORITY' OR fees_category = 'SINDHI(EBC)' OR fees_category = 'SINDHI'  )  and status = 'CANCELLED' and shift_allotted = 'Afternoon' and admission_type = 'DTE'"));
                $user7 = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =  'SINDHI' OR fees_category = 'SINDHI(EBC)' OR fees_category = 'SINDHI' )  and status = 'ADMITTED' and shift_allotted = 'Afternoon' and admission_type = 'ACAP'"));
                $user8 = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =   'SINDHI' OR fees_category = 'SINDHI(EBC)' OR fees_category = 'SINDHI' )  and status = 'CANCELLED' and shift_allotted = 'Afternoon' and admission_type = 'ACAP'"));
                
                $user9 = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN MU' OR fees_category = 'OPEN OMU'  OR fees_category = 'OBC/EBC MU' OR fees_category = 'OBC/EBC OMU' OR fees_category = 'SC/ST/VJ/DT/NT/SBC MU' OR fees_category = 'SC/ST/VJ/DT/NT/SBC OMU' OR fees_category = 'JK/GOI/NEUT' OR fees_category = 'OMS' OR fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'J&K' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT')  and status = 'ADMITTED'  and shift_allotted = 'Morning' and admission_type = 'DTE'"));
                $user10 = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN MU' OR fees_category = 'OPEN OMU'  OR fees_category = 'OBC/EBC MU' OR fees_category = 'OBC/EBC OMU' OR fees_category = 'SC/ST/VJ/DT/NT/SBC MU' OR fees_category = 'SC/ST/VJ/DT/NT/SBC OMU' OR fees_category = 'JK/GOI/NEUT' OR fees_category = 'OMS' OR fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'J&K' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' )  and status = 'CANCELLED'  and shift_allotted = 'Morning' and admission_type = 'DTE'"));
                $user11= DB::select(DB::raw("SELECT * FROM `admission` WHERE ( fees_category = 'OPEN' OR fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'J&K' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' )  and status = 'ADMITTED'  and shift_allotted = 'Morning' and admission_type = 'ACAP'"));
                $user12 = DB::select(DB::raw("SELECT * FROM `admission` WHERE ( fees_category = 'OPEN' OR fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'J&K' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' )  and status = 'CANCELLED'  and shift_allotted = 'Morning' and admission_type = 'ACAP'"));
               
               $user13 = DB::select(DB::raw("SELECT * FROM `admission` WHERE ( fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'J&K' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'OPEN MU' OR fees_category = 'OPEN OMU'  OR fees_category = 'OBC/EBC MU' OR fees_category = 'OBC/EBC OMU' OR fees_category = 'SC/ST/VJ/DT/NT/SBC MU' OR fees_category = 'SC/ST/VJ/DT/NT/SBC OMU' OR fees_category = 'JK/GOI/NEUT' OR fees_category = 'OMS' )  and status = 'ADMITTED'  and shift_allotted = 'Afternoon' and admission_type = 'DTE'"));
                $user14 = DB::select(DB::raw("SELECT * FROM `admission` WHERE ( fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'J&K' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'OPEN MU' OR fees_category = 'OPEN OMU'  OR fees_category = 'OBC/EBC MU' OR fees_category = 'OBC/EBC OMU' OR fees_category = 'SC/ST/VJ/DT/NT/SBC MU' OR fees_category = 'SC/ST/VJ/DT/NT/SBC OMU' OR fees_category = 'JK/GOI/NEUT' OR fees_category = 'OMS' )  and status = 'CANCELLED'  and shift_allotted = 'Afternoon' and admission_type = 'DTE'"));
                 $user15= DB::select(DB::raw("SELECT * FROM `admission` WHERE (  fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'J&K' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'OPEN' )  and status = 'ADMITTED'  and shift_allotted = 'Afternoon' and admission_type = 'ACAP'"));
                $user16 = DB::select(DB::raw("SELECT * FROM `admission` WHERE ( fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'J&K' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR  fees_category = 'OPEN' )  and status = 'CANCELLED'  and shift_allotted = 'Afternoon' and admission_type = 'ACAP'"));
         ...
         else if($course =="FEG")
         {
           ...
           $userCMPNDTESA1=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'ADMITTED' and branch = 'CMPN' and course='FEG' and shift_allotted = '1st-Shift' or shift_allotted = '1st shift' and admission_type = 'DTE'"));

            //CMPN For SINDHI CANCELLED DTE SHIFT 1
           $userCMPNDTESC1=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'CANCELLED' and branch = 'CMPN'and  course='FEG' and shift_allotted = '1st-Shift' or shift_allotted = '1st shift'  and admission_type = 'DTE'"));

            //CMPN For SINDHI ADMITTED ACAP SHIFT 1
           $userCMPNACAPSA1=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'ADMITTED' and branch = 'CMPN' and  course='FEG' and (shift_allotted = '1st-Shift' or shift_allotted = '1st shift') and admission_type = 'ACAP'"));

            //CMPN For SINDHI CANCELLED ACAP SHIFT 1
           $userCMPNACAPSC1=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'CANCELLED' and branch = 'CMPN'and  course='FEG' and shift_allotted = '1st-Shift' or shift_allotted = '1st shift' and admission_type = 'ACAP'"));


         //CMPN For SINDHI ADMITTED DTE SHIFT 2
           $userCMPNDTESA2=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'ADMITTED' and branch = 'CMPN' and  course='FEG' and shift_allotted = '2nd-Shift' and admission_type = 'DTE'"));

            //CMPN For SINDHI CANCELLED DTE SHIFT 2
           $userCMPNDTESC2=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'CANCELLED' and branch = 'CMPN'and  course='FEG' and shift_allotted = '2nd-Shift' and admission_type = 'DTE'"));

            //CMPN For SINDHI ADMITTED ACAP SHIFT 2
           $userCMPNACAPSA2=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'ADMITTED' and branch = 'CMPN' and  course='FEG' and shift_allotted = '2nd-Shift' and admission_type = 'ACAP'"));

            //CMPN For SINDHI CANCELLED ACAP SHIFT 2
           $userCMPNACAPSC2=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'CANCELLED' and branch = 'CMPN'and  course='FEG' and shift_allotted = '2nd-Shift' and admission_type = 'ACAP'"));



            //IT For SINDHI ADMITTED DTE
            $userITDTESA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI'  OR fees_category = 'SINDHI(EBC)' )  and status = 'ADMITTED' and branch = 'INFT' and admission_type = 'DTE'  and course='FEG'"));

            //IT For SINDHI CANCELLED DTE
            $userITDTESC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'CANCELLED' and branch = 'INFT' and admission_type = 'DTE' and course='FEG'"));

            //IT For SINDHI ADMITTED ACAP
            $userITACAPSA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category ='SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'ADMITTED' and branch = 'INFT' and admission_type = 'ACAP' and course='FEG'"));

            //IT For SINDHI CANCELLED ACAP
            $userITACAPSC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =  'SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'CANCELLED' and branch = 'INFT' and admission_type = 'ACAP' and course='FEG'"));




            //INST For SINDHI ADMITTED DTE
            $userINSTDTESA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'ADMITTED' and branch = 'INST' and admission_type = 'DTE' and course='FEG'"));

            //INST For SINDHI CANCELLED DTE
            $userINSTDTESC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'CANCELLED' and branch = 'INST' and admission_type = 'DTE' and course='FEG'"));

            //INST For SINDHI ADMITTED ACAP
            $userINSTACAPSA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category ='SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'ADMITTED' and branch = 'INST' and admission_type = 'ACAP' and course='FEG'"));
            
            //INST For SINDHI CANCELLED ACAP
            $userINSTACAPSC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =  'SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'CANCELLED' and branch = 'INST' and admission_type = 'ACAP' and course='FEG'"));

            
             //AIDS For SINDHI ADMITTED DTE
            $userAIDSDTESA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'ADMITTED' and branch = 'AIDS' and admission_type = 'DTE' and course='FEG'"));

            //AIDS For SINDHI CANCELLED DTE
            $userAIDSDTESC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'CANCELLED' and branch = 'AIDS' and admission_type = 'DTE' and course='FEG'"));

            //AIDS For SINDHI ADMITTED ACAP
            $userAIDSACAPSA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category ='SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'ADMITTED' and branch = 'AIDS' and admission_type = 'ACAP' and course='FEG'"));
            
            //AIDS For SINDHI CANCELLED ACAP
            $userAIDSACAPSC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =  'SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'CANCELLED' and branch = 'AIDS' and admission_type = 'ACAP' and course='FEG'"));


            //EXTC For SINDHI ADMITTED DTE
           $userEXTCDTESA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'ADMITTED' and branch = 'EXTC' and admission_type = 'DTE' and course='FEG'"));

            //EXTC For SINDHI CANCELLED DTE
           $userEXTCDTESC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'CANCELLED' and branch = 'EXTC' and admission_type = 'DTE' and course='FEG'"));

            //EXTC For SINDHI ADMITTED ACAP
           $userEXTCACAPSA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =   'SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'ADMITTED' and branch = 'EXTC' and admission_type = 'ACAP' and course='FEG'"));

            //EXTC For SINDHI CANCELLED ACAP           
           $userEXTCACAPSC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =  'SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'CANCELLED' and branch = 'EXTC' and admission_type = 'ACAP' and course='FEG'"));
...
//$userEXTCDTESA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN SINDHI MINORITY' )  and status = 'ADMITTED' and branch = 'EXTC' and admission_type = 'DTE'"));
           ...
           //      $userEXTCACAPSC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =  'SINDHI')  and status = 'CANCELLED' and branch = 'EXTC' and admission_type = 'ACAP'"));
            ...
            $userETRXDTESA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'ADMITTED' and branch = 'ETRX' and admission_type = 'DTE' and course='FEG'"));

            //ETRX For SINDHI CANCELLED DTE
            $userETRXDTESC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI'  OR fees_category = 'SINDHI(EBC)' )  and status = 'CANCELLED' and branch = 'ETRX' and admission_type = 'DTE' and course='FEG'"));

            //ETRX For SINDHI ADMITTED ACAP
            $userETRXACAPSA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =   'SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'ADMITTED' and branch = 'ETRX' and admission_type = 'ACAP' and course='FEG'"));

            //ETRX For SINDHI CANCELLED ACAP            
            $userETRXACAPSC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =  'SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'CANCELLED' and branch = 'ETRX' and admission_type = 'ACAP' and course='FEG'"));
               



            //CMPN For GENERAL ADMITTED DTE SHIFT 1
            $userCMPNDTEOA1 = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS')  and status = 'ADMITTED'  and branch = 'CMPN' and  course='FEG'and shift_allotted = '1st-Shift' and admission_type = 'DTE'"));

            //CMPN For GENERAL CANCELLED DTE SHIFT 1
            $userCMPNDTEOC1 = DB::select(DB::raw("SELECT * FROM `admission` WHERE ( fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'CANCELLED'  and branch = 'CMPN' and  course='FEG'and shift_allotted = '1st-Shift' and admission_type = 'DTE'"));

            //CMPN For GENERAL ADMITTED ACAP SHIFT 1
             $userCMPNACAPOA1= DB::select(DB::raw("SELECT * FROM `admission` WHERE (  fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'ADMITTED'  and branch = 'CMPN' and  course='FEG' and shift_allotted = '1st-Shift' and admission_type = 'ACAP'"));

            //CMPN For GENERAL CANCELLED ACAP SHIFT 1
             $userCMPNACAPOC1 = DB::select(DB::raw("SELECT * FROM `admission` WHERE (  fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'CANCELLED'  and branch = 'CMPN' and  course='FEG' and shift_allotted = '1st-Shift' and admission_type = 'ACAP'"));
            ...
            $userCMPNDTEOC2 = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN'  OR fees_category = 'GENERAL'  OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'CANCELLED'  and branch = 'CMPN' and  course='FEG' and shift_allotted = '2nd-Shift' and admission_type = 'DTE'"));

            //CMPN For GENERAL ADMITTED ACAP SHIFT 2
             $userCMPNACAPOA2= DB::select(DB::raw("SELECT * FROM `admission` WHERE ( fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS'   )  and status = 'ADMITTED'  and branch = 'CMPN' and  course='FEG' and shift_allotted = '2nd-Shift' and admission_type = 'ACAP'"));

            //CMPN For GENERAL CANCELLED ACAP SHIFT 2
             $userCMPNACAPOC2 = DB::select(DB::raw("SELECT * FROM `admission` WHERE (  fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS'    )  and status = 'CANCELLED'  and branch = 'CMPN' and  course='FEG'and shift_allotted = '2nd-Shift' and admission_type = 'ACAP'"));



            //IT For GENERAL ADMITTED DTE                
            $userITDTEOA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN' OR fees_category = 'GENERAL'  OR fees_category = 'OPEN_CI' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'ADMITTED'  and branch = 'INFT' and admission_type = 'DTE' and course='FEG'"));

            //IT For GENERAL CANCELLED DTE
            $userITDTEOC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'OPEN_CI' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'CANCELLED'  and branch = 'INFT' and admission_type = 'DTE' and course='FEG'"));

            //IT For GENERAL ADMITTED ACAP
              $userITACAPOA= DB::select(DB::raw("SELECT * FROM `admission` WHERE (  fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS'    )  and status = 'ADMITTED'  and branch = 'INFT' and admission_type = 'ACAP' and course='FEG'"));

            //IT For GENERAL CANCELLED ACAP
             $userITACAPOC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (  fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS'    )  and status = 'CANCELLED'  and branch = 'INFT' and admission_type = 'ACAP' and course='FEG'"));
               



            //INST For GENERAL ADMITTED DTE                
           $userINSTDTEOA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN' OR fees_category = 'GENERAL'  OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS'  )  and status = 'ADMITTED'  and branch = 'INST' and admission_type = 'DTE' and course='FEG'"));

            //INST For GENERAL CANCELLED DTE                
            $userINSTDTEOC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN' OR fees_category = 'GENERAL'  OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS'  OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'CANCELLED'  and branch = 'INST' and admission_type = 'DTE' and course='FEG'"));

             //INST For GENERAL ADMITTED ACAP                           
            $userINSTACAPOA= DB::select(DB::raw("SELECT * FROM `admission` WHERE (  fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS'  )  and status = 'ADMITTED'  and branch = 'INST' and admission_type = 'ACAP' and course='FEG'"));

            //INST For GENERAL CANCELLED ACAP                            
            $userINSTACAPOC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (  fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS'   )  and status = 'CANCELLED'  and branch = 'INST' and admission_type = 'ACAP' and course='FEG'"));
            
            //AIDS For GENERAL ADMITTED DTE                
           $userAIDSDTEOA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN' OR fees_category = 'GENERAL'  OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'ADMITTED'  and branch = 'AIDS' and admission_type = 'DTE' and course='FEG'"));

            //AIDS For GENERAL CANCELLED DTE                
            $userAIDSDTEOC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN' OR fees_category = 'GENERAL'  OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'CANCELLED'  and branch = 'AIDS' and admission_type = 'DTE' and course='FEG'"));

             //AIDS For GENERAL ADMITTED ACAP                           
            $userAIDSACAPOA= DB::select(DB::raw("SELECT * FROM `admission` WHERE (  fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS'  )  and status = 'ADMITTED'  and branch = 'AIDS' and admission_type = 'ACAP' and course='FEG'"));

            //AIDS For GENERAL CANCELLED ACAP                            
            $userAIDSACAPOC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (  fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS'   )  and status = 'CANCELLED'  and branch = 'AIDS' and admission_type = 'ACAP' and course='FEG'"));



            //EXTC For GENERAL ADMITTED DTE                
           $userEXTCDTEOA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN' OR fees_category = 'GENERAL'  OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'ADMITTED'  and branch = 'EXTC' and admission_type = 'DTE' and course='FEG'"));

            //EXTC For GENERAL CANCELLED DTE                
           $userEXTCDTEOC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN' OR fees_category = 'GENERAL'  OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'CANCELLED'  and branch = 'EXTC' and admission_type = 'DTE' and course='FEG'"));

            //EXTC For GENERAL ADMITTED ACAP                
           $userEXTCACAPOA= DB::select(DB::raw("SELECT * FROM `admission` WHERE (  fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS'   )  and status = 'ADMITTED'  and branch = 'EXTC' and admission_type = 'ACAP' and course='FEG'"));

            //EXTC For GENERAL CANCELLED ACAP                
           $userEXTCACAPOC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (  fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS'   )  and status = 'CANCELLED'  and branch = 'EXTC' and admission_type = 'ACAP' and course='FEG'"));
               


           //ETRX For GENERAL ADMITTED DTE                
           $userETRXDTEOA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN' OR fees_category = 'GENERAL'  OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'ADMITTED'  and branch = 'ETRX' and admission_type = 'DTE' and course='FEG'"));

            //ETRX For GENERAL CANCELLED DTE                
           $userETRXDTEOC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'OPEN' OR fees_category = 'GENERAL'  OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'CANCELLED'  and branch = 'ETRX' and admission_type = 'DTE' and course='FEG'"));

            //ETRX For GENERAL ADMITTED ACAP                
           $userETRXACAPOA= DB::select(DB::raw("SELECT * FROM `admission` WHERE (  fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS'   )  and status = 'ADMITTED'  and branch = 'ETRX' and admission_type = 'ACAP' and course='FEG'"));

            //ETRX For GENERAL CANCELLED ACAP                
           $userETRXACAPOC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (  fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS'   )  and status = 'CANCELLED'  and branch = 'ETRX' and admission_type = 'ACAP' and course='FEG'"));
          ...
          $dAI5 = count($userAIDSDTESA); // AIDS sindhi admitted  dte
          $dAI6 = count($userAIDSDTESC); // AIDS sindhi cancelled  dte
                
          $DAIDSs = $dAI5-$dAI6; // AIDS dte admitted sindhi 
                
          $dAI7 = count($userAIDSACAPSA); // AIDS   admitted  acap sindhi
          $dAI8 = count($userAIDSACAPSC); // AIDS  cancelled  acap sindhi
                
          $AAIDSs = $dAI7-$dAI8; // AIDS  acap admitted sindhi        
          ...
          $dAIDS25 = count($userAIDSDTEOA); // AIDS open admitted dte
          $dAIDS26 = count($userAIDSDTEOC); // AIDS  open cancelled dte
                
          $DAIDSo = $dAIDS25-$dAIDS26; // AIDS  dte admitted open 
                
          $dAIDS27 = count($userAIDSACAPOA); // AIDS  admitted acap open
          $dAIDS28 = count($userAIDSACAPOC); // AIDS  cancelled acap open
                
          $AAIDSo = $dAIDS27-$dAIDS28; // AIDS   acap admitted open
          ...
          $ACMPN2o = $d47-$d48;// CMPN  acap admitted shift 2 open
                ...
                $remIT= 120-($DITs+$AITs+$DITo+$AITo);
                $fillIT= $DITs+$AITs+$DITo+$AITo;

                $remINST= 60-($DINSTs+$AINSTs+$DINSTo+$AINSTo);
                $fillINST= $DINSTs+$AINSTs+$DINSTo+$AINSTo;
                
                $remAIDS= 60-($DAIDSs+$AAIDSs+$DAIDSo+$AAIDSo);
                $fillAIDS= $DAIDSs+$AAIDSs+$DAIDSo+$AAIDSo;

                $remEXTC= 120-($DEXTCs+$AEXTCs+$DEXTCo+$AEXTCo);
                ...
                $remCMPN1= 120-($DCMPN1s+$ACMPN1s+$DCMPN1o+$ACMPN1o);
                ...
                $data['remAIDS']=$remAIDS;
                $data['fillAIDS']=$fillAIDS;
         ...
         else if($course =="DSE")
         {
            ...
            //CMPN For SINDHI ADMITTED DTE SHIFT 1
           $userCMPNDTESA1=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'ADMITTED' and branch = 'CMPN' and course='DSE' and shift_allotted = '1st-Shift' and admission_type = 'DTE'"));

            //CMPN For SINDHI CANCELLED DTE SHIFT 1
           $userCMPNDTESC1=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'CANCELLED' and branch = 'CMPN' and course='DSE' and shift_allotted = '1st-Shift' and admission_type = 'DTE'"));

            //CMPN For SINDHI ADMITTED ACAP SHIFT 1
           $userCMPNACAPSA1=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'ADMITTED' and branch = 'CMPN' and course='DSE' and shift_allotted = '1st-Shift' and admission_type = 'ACAP'"));

            //CMPN For SINDHI CANCELLED ACAP SHIFT 1
           $userCMPNACAPSC1=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'CANCELLED' and branch = 'CMPN' and course='DSE' and shift_allotted = '1st-Shift' and admission_type = 'ACAP'"));


         //CMPN For SINDHI ADMITTED DTE SHIFT 2
           $userCMPNDTESA2=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'ADMITTED' and branch = 'CMPN' and course='DSE' and shift_allotted = '2nd-Shift' and admission_type = 'DTE'"));

            //CMPN For SINDHI CANCELLED DTE SHIFT 2
           $userCMPNDTESC2=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'CANCELLED' and branch = 'CMPN'and course='DSE' and shift_allotted = '2nd-Shift' and admission_type = 'DTE'"));

            //CMPN For SINDHI ADMITTED ACAP SHIFT 2
           $userCMPNACAPSA2=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'ADMITTED' and branch = 'CMPN' and course='DSE' and shift_allotted = '2nd-Shift' and admission_type = 'ACAP'"));

            //CMPN For SINDHI CANCELLED ACAP SHIFT 2
           $userCMPNACAPSC2=DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'CANCELLED' and branch = 'CMPN' and course='DSE' and shift_allotted = '2nd-Shift' and admission_type = 'ACAP'"));



            //IT For SINDHI ADMITTED DTE
            $userITDTESA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'ADMITTED' and branch = 'INFT' and admission_type = 'DTE' and course='DSE'"));

            //IT For SINDHI CANCELLED DTE
            $userITDTESC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'CANCELLED' and branch = 'INFT' and admission_type = 'DTE' and course='DSE'"));

            //IT For SINDHI ADMITTED ACAP
            $userITACAPSA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category ='SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'ADMITTED' and branch = 'INFT' and admission_type = 'ACAP' and course='DSE'"));

            //IT For SINDHI CANCELLED ACAP
            $userITACAPSC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =  'SINDHI' OR fees_category = 'SINDHI(EBC)' )  and status = 'CANCELLED' and branch = 'INFT' and admission_type = 'ACAP' and course='DSE'"));
            ...
            //INST For SINDHI CANCELLED DTE
            $userINSTDTESC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'   )  and status = 'CANCELLED' and branch = 'INST' and admission_type = 'DTE' and course='DSE'"));

            //INST For SINDHI ADMITTED ACAP
            $userINSTACAPSA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =   'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'ADMITTED' and branch = 'INST' and admission_type = 'ACAP' and course='DSE'"));
            
            //INST For SINDHI CANCELLED ACAP
            $userINSTACAPSC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =  'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'CANCELLED' and branch = 'INST' and admission_type = 'ACAP' and course='DSE'"));



            //EXTC For SINDHI ADMITTED DTE
           $userEXTCDTESA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'   )  and status = 'ADMITTED' and branch = 'EXTC' and admission_type = 'DTE' and course='DSE'"));

            //EXTC For SINDHI CANCELLED DTE
           $userEXTCDTESC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'   )  and status = 'CANCELLED' and branch = 'EXTC' and admission_type = 'DTE' and course='DSE'"));

            //EXTC For SINDHI ADMITTED ACAP
           $userEXTCACAPSA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =   'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'ADMITTED' and branch = 'EXTC' and admission_type = 'ACAP' and course='DSE'"));

            //EXTC For SINDHI CANCELLED ACAP           
           $userEXTCACAPSC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =  'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'CANCELLED' and branch = 'EXTC' and admission_type = 'ACAP' and course='DSE'"));
               


            //ETRX For SINDHI ADMITTED DTE
            $userETRXDTESA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'   )  and status = 'ADMITTED' and branch = 'ETRX' and admission_type = 'DTE' and course='DSE'"));

            //ETRX For SINDHI CANCELLED DTE
            $userETRXDTESC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'   )  and status = 'CANCELLED' and branch = 'ETRX' and admission_type = 'DTE' and course='DSE'"));

            //ETRX For SINDHI ADMITTED ACAP
            $userETRXACAPSA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =   'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'ADMITTED' and branch = 'ETRX' and admission_type = 'ACAP' and course='DSE'"));

            //ETRX For SINDHI CANCELLED ACAP            
            $userETRXACAPSC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =  'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'CANCELLED' and branch = 'ETRX' and admission_type = 'ACAP' and course='DSE'"));
               
            
            //AIDS For SINDHI ADMITTED DTE
            $userAIDSDTESA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'   )  and status = 'ADMITTED' and branch = 'AIDS' and admission_type = 'DTE' and course='DSE'"));

            //AIDS For SINDHI CANCELLED DTE
            $userAIDSDTESC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category = 'SINDHI' OR fees_category = 'SINDHI(EBC)'   )  and status = 'CANCELLED' and branch = 'AIDS' and admission_type = 'DTE' and course='DSE'"));

            //AIDS For SINDHI ADMITTED ACAP
            $userAIDSACAPSA = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =   'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'ADMITTED' and branch = 'AIDS' and admission_type = 'ACAP' and course='DSE'"));

            //AIDS For SINDHI CANCELLED ACAP            
            $userAIDSACAPSC = DB::select(DB::raw("SELECT * FROM `admission` WHERE (fees_category =  'SINDHI' OR fees_category = 'SINDHI(EBC)'  )  and status = 'CANCELLED' and branch = 'AIDS' and admission_type = 'ACAP' and course='DSE'"));
            ...
            //CMPN For GENERAL ADMITTED ACAP SHIFT 2
             $userCMPNACAPOA2= DB::select(DB::raw("SELECT * FROM `admission` WHERE ( fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'ADMITTED'  and branch = 'CMPN' and course='DSE' and shift_allotted = '2nd-Shift' and admission_type = 'ACAP'"));
            ...
            //IT For GENERAL ADMITTED DTE                
            $userITDTEOA = DB::select(DB::raw("SELECT * FROM `admission` WHERE ( fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'ADMITTED'  and branch = 'INFT' and admission_type = 'DTE' and course='DSE'"));

            //IT For GENERAL CANCELLED DTE
            $userITDTEOC = DB::select(DB::raw("SELECT * FROM `admission` WHERE ( fees_category = 'OPEN' OR fees_category = 'GENERAL' OR fees_category = 'SBC'  OR fees_category = 'NT' OR fees_category = 'SC' OR fees_category = 'OBC' OR fees_category = 'ST' OR fees_category = 'PMSS' OR fees_category = 'JK' OR fees_category = 'GOI' OR fees_category = 'NEUT' OR fees_category = 'TFWS' OR fees_category = 'VJ' OR fees_category = 'EBC' OR fees_category = 'DT' OR fees_category = 'JKPMSSS' )  and status = 'CANCELLED'  and branch = 'INFT' and admission_type = 'DTE' and course='DSE'"));
...
//
          $d13AIDS = count($userAIDSDTESA); // AIDS sindhi admitted  dte
          $d14AIDS = count($userAIDSDTESC); // AIDS sindhi cancelled  dte
                
          $DAIDSs = $d13AIDS-$d14AIDS; // AIDS  dte admitted sindhi 
                
          $d15AIDS = count($userAIDSACAPSA); // AIDS   admitted acap sindhi
          $d16AIDS = count($userAIDSACAPSC); // AIDS  cancelled acap sindhi
                
          $AAIDSs = $d15AIDS-$d16AIDS;// AIDS  acap admitted sindhi
          ...
          $d33AIDS = count($userAIDSDTEOA); // AIDS open admitted dte
          $d34AIDS = count($userAIDSDTEOC); // AIDS open cancelled dte
                
          $DAIDSo = $d33AIDS-$d34AIDS; // AIDS  dte admitted open 
                
          $d35AIDS = count($userAIDSACAPOA); // AIDS   admitted acap open
          $d36AIDS = count($userAIDSACAPOC); // AIDS  cancelled acap open
                
          $AAIDSo = $d35AIDS-$d36AIDS;// AIDS  acap admitted open
          ...
          $ACMPN2o = $d47-$d48;// CMPN  acap admitted shift 2 open
                ...
                $remIT= 12-($DITs+$AITs+$DITo+$AITo);
                $fillIT= $DITs+$AITs+$DITo+$AITo;

                $remINST= 6-($DINSTs+$AINSTs+$DINSTo+$AINSTo);
                $fillINST= $DINSTs+$AINSTs+$DINSTo+$AINSTo;

                $remEXTC= 12-($DEXTCs+$AEXTCs+$DEXTCo+$AEXTCo);
                $fillEXTC= $DEXTCs+$AEXTCs+$DEXTCo+$AEXTCo;
                ...
                $remAIDS= 6-($DAIDSs+$AAIDSs+$DAIDSo+$AAIDSo);
                $fillAIDS= $DAIDSs+$AAIDSs+$DAIDSo+$AAIDSo;

                $remCMPN1= 12-($DCMPN1s+$ACMPN1s+$DCMPN1o+$ACMPN1o);
                $fillCMPN1= $DCMPN1s+$ACMPN1s+$DCMPN1o+$ACMPN1o;
...
public static function postAdminSeizer(Request $request)
    {
        ...
        if ($request->session()->has('dte')) 
        {
           ...
           // return $course;
            ...
            if($course == "DSE"){
              $category = DB::table('dse_students')->select('category','acap_category')->where('dte_id',$dte_id)->get();
                $amount =  DB::table('fees_structure')->select('amt')->where('fee_category','GENERAL')->where('course',$course)->get();
            } 
             ...
             // return $category[0]->university_type;
            }
...
public static function AfterSearchAdminPartPayment(Request $request)
    {
         ...
         $course =$request->session()->get('adminCourse');
          $event =$request->session()->get('adminEvent',null);
          $event1 =$request->session()->get('event',null);
        // return $event;
        //  $event ="DTE";
        if($course == "MEG")
        {
            ...
            $upload = json_decode(json_encode($array_object));
              ...
              if(DB::table('admission')->where('dte_id', $dte_id)->exists()) 
                 { 
                  ...
                  // return $event;
                         if($event=='ACAP'){
                               $admission = DB::table('admission')->where('dte_id','LIKE','%'.$dte_id.'%')->where('admission_type',$event)->get();
                               // return $admission;
                            }
                            else{
                                $admission = DB::table('admission')->where('dte_id','LIKE','%'.$dte_id.'%')->where('admission_type',$event)->get();
            ...
            if($users[0]->status_to == 'SEIZED')
            {
              // return"abc1";
               ...
               if($payment == [])
               {
                    ...
                    $user3 = DB::table('admission')->select('balance_amt')->where('admission_type',$event1[0]->event)->where('dte_id',$dte_id)->get();
              
             // return $user3[0]->balance_amt; 
                              if($course == "MEG")
                              {
                                $user3[0]->balance_amt=null; //TEMP CHANGE
                                   if($user3 == '[]' || $user3[0]->balance_amt == null)
                                 {
                                    ...
                                    {
                                      $seat_type = DB::table('me_students')->select('acap_category','university_type')->where('dte_id',$dte_id)->get();
                  ...
                  $fees = DB::table('fees_structure')->where('fee_category','GENERAL')->where('board',$seat_type[0]->university_type)->where('course',$course)->get();// temp change
                                          ...
                                          $part['amt'] = $partpay[0]->amt;
                                           $array_object = [['amt' => null]];
                                             ...
                                             DB::table('admission')->where('dte_id', $dte_id)->where('admission_type',$event)->where('course',$course)->update(['granted_amt' => $partpay[0]->amt]);
                                              ...
                                              $user4= DB::table('admission')->select()->where('dte_id', $dte_id)->where('admission_type',$event)->where('course',$course)->get();
   ...
   if($users[0]->status_to == 'SEIZED')
            {
             ...
             // return $user3[0]->balance_amt;
                  ...
                  // $fees = DB::table('fees_structure')->where([['fee_category',$seat_type[0]->acap_category],['course',$course],['board',$board]])->get();
                     ...
                     if($seat_type[0]->xii_board=='CBSE' || $seat_type[0]->xii_board=='Maharashtra board' || $seat_type[0]->xii_board=='ICSE'){
                    $fees =  DB::table('fees_structure')->select('amt')->where('fee_category','GENERAL')->where('board',$seat_type[0]->xii_board)->where('course',$course)->get();                   
                  }else{
                      $fees =  DB::table('fees_structure')->select('amt')->where('fee_category','GENERAL')->where('board','OTHER')->where('course',$course)->get();
                    // return $course;
                  // return $fees;

                  }

                 //  $fees = DB::table('fees_structure')->where([['fee_category','GENERAL'],['course',$course],['board',$seat_type[0]->xii_board]])->get();
                 // // return $seat_type[0]->acap_category;
                 //  //return $payment;
                 //  // return $fees;
                              ...
                              $partpay = DB::table('part_payment')->where('dte_id',$dte_id)->get();
                                    ...
                                    if($partpay == '[]' )
                                    {
                                      ...
                                      else
                                      {
                                        ...
                                        // return $dte_id;
                  $request->session()->put('admissID',$department[0]->admission_id);
                  $fees = DB::table('fees_structure')->where([['fee_category','GENERAL'],['course',$course]])->get();
                  //return $fees;                  
                  $request->session()->put('balanceAmt',$user4[0]->balance_amt);
                     $request->session()->put('fees',$fees[0]->amt);
                    $request->session()->put('part',$part['amt']);
     ...
     public static function postAdminPrintForm(Request $request)
    {
        ...
        //  $user = DB::select(DB::raw(" SELECT * from admission where dte_id like '%".$dte_id."%' and status='ADMITTED' and admission_type like  '%".$event ."%' order by updated_at desc limit 1"));
        ...
        if($user[0]->status=='ADMITTED')
        {
                ...
                //  return $user4;
                 ...
                 {
                     $user5 = DB::select(DB::raw("SELECT * FROM `cash_details` WHERE dte_id LIKE '%".$dte_id."%' ORDER BY updated_at DESC LIMIT 1")); 
                     $ddno = $user5[0]->recipt_no;
                     $bank_name =null;
                     $amount = $user5[0]->amount;
                     $Trans_id  = null;
                     $ref_no = null;
                 }
                ...
                //   return $user;
                  if($event=='DTE')
                  {
                    ...
                    if($users3[0]->branch=="CMPN"){
                    if( $users1['shift_allotted']=='1st shift' or $users1['shift_allotted']=='1st-Shift' or $users1['shift_allotted']=='1st Shift'  ){
                        $users1['shift_allotted']= 'Morning I';
                    }
                        else{
                        $users1['shift_allotted']= 'Morning II';    
                  ...
                  if($event=='ACAP')
                  {
                    ...
                    $users1['shift_allotted']=$user[0]->shift_allotted;
                    //  if( $users1['shift_allotted']=='Morning'){
                    //     $users1['shift_allotted']= 'Morning I';
                    // }
                    //     else{
                    //     $users1['shift_allotted']= 'Morning II';    
                    ...
                    if($users1['branch_allotted'] == 'AIDS'){
                        $users1['branch_allotted']='Ai&Ds';
                    }
                  ...
                  if($course == "MCA")
                  {
                    ...
                    {
                    //   return view('user.mca.pdfview2',$users1);
                 ...
                 if($event == "DTE")
                  ...
                  //return "h";
                   ...
                   // return $u1;
                    ...
                    if ($prev_count<8 OR $prev_status=='CANCELLED') {
                        
                //   if($prev_count==2 || $prev_count==4 || $prev_count==6){
                       if($prev_count==2 || $prev_count==4 || $prev_count==6 || $prev_count==0 || $prev_count==1){
   ...
   // return $payment;
     ...
     public static function postAdminCancelAdmission(Request $request)
    {
        ...
        if ($request->session()->has('dte')) 
        {
            ...
            $dte_id = $request->session()->pull('dte');
             //return $dte_id;
            $admissionType = $request->session()->pull('event');
...
public static function showadminFormViewFE(Request $request)
    ...
    /*  if($request->session()->get('dte',null)!=null)
     ...
     elseif($request->session()->get('dte1',null)!=null)
      ...
      $categorie=DB::select(DB::raw("SELECT GROUP_CONCAT( DISTINCT fee_category )AS fee_category FROM fees_structure"));
       $categories=explode(",",$categorie[0]->fee_category);
       array_push($categories ,"NA");
...
public static function PostCashPayment(Request $request){
             ...
             //              }
               ...
               $users= DB::insert('insert into cash_details( amount, dte_id,  recipt_no, reciptdate)  values ( ?,?,?,?)', [$reciptamnt,$dte_id,$reciptno,$reciptdate]);
...
public static function postfeestransfer(Request $request){  
  $dte_id = $request->input('dte_id');
  $sub_merchant_id = $request->input('sub_merchant_id');
  $ref_no = $request->input('ref_no');
  $init_amt = $request->input('init_amt');
  $s_tax_amt = $request->input('s_tax_amt');
  $payment_mode = $request->input('payment_mode');
  $trans_status = $request->input('trans_status');
  $response_code = $request->input('response_code');
  $admission_id = $request->session()->get('admissID');  
  $admission_type = $request->input('admissiontypetransfer');
  ...
  date_default_timezone_set("Asia/Kolkata");
               $Admission = admission::find($admission_id);
                          if($Admission->balance_amt>0){                          
                          $Admission->paid_amt =  $trans_amt;    
                          $balance_amt=$Admission->balance_amt-$trans_amt;                         
                          $Admission->balance_amt = $balance_amt;                       
                          $Admission->save();
                        }
            ...
            if($course == "FEG")
             ...
             if($course == "DSE")
              ...
              $fee->trans_status = $trans_status;                
              $fee->trans_timestamp = date("Y-m-d h:i:s");
              $fee->trans_amt = $trans_amt;
              $fee->init_amt = $init_amt;
              $fee->total_amt =$total_amt;
              $fee->payment_timestamp = date("Y-m-d h:i:s");
              $fee->admission_id = $admission_id;
              $fee->response_code = $response_code;
              $fee->admission_type = 'ACAP';
              $fee->save();              
              $request->session()->flash('error', 'Transfer SUCCESSFULL');
              return redirect()->route('adminAdmit');
}
public static function feestransfer(Request $request){
    $dte_id = $request->session()->get('dte');
    if(DB::table('fees_transaction')->where('dte_id',$dte_id)->where('trans_status','like','Success')->where('admission_type',"DTE")->exists()){    
         $feestransaction=DB::table('fees_transaction')->where('dte_id',$dte_id)->where('trans_status','like','Success')->where('admission_type',"DTE")->get(); //for old transaction dte

      $admission_id = $request->session()->get('admissID');//current transaction
     
       $acapamtdetails=DB::table('admission')->where('admission_id',$admission_id)->get();
         //previos paid 


 return view('admin.feestransfer')->with('data',$feestransaction)->with('newdata',$acapamtdetails);
    }
